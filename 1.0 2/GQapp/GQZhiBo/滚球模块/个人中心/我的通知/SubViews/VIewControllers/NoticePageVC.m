...
@interface NoticePageVC ()<ViewPagerDelegate,ViewPagerDataSource,NavViewDelegate>
@property (nonatomic, assign) NSInteger currentIndex;
@property (nonatomic, strong) UISegmentedControl *segmentEvent;
@end

@implementation NoticePageVC
...
- (UIViewController *)viewPager:(ViewPagerController *)viewPager contentViewControllerForTabAtIndex:(NSUInteger)index
{
    switch (index) {
        case 0:
        {
            RemindViewController *noticeVC = [[RemindViewController alloc] init];
            return noticeVC;
        }
            break;
        case 1:
