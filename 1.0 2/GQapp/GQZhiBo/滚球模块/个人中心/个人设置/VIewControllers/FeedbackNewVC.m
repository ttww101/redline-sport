...
//  GQapp
//
//  Created by Marjoice on 20/09/2017.
...
@interface FeedbackNewVC ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate>
...
- (FeedBackHeaderView *)feedBackHeaderView {
    ...
    if (!_feedBackHeaderView) {
        _feedBackHeaderView = [[FeedBackHeaderView alloc] initWithFrame:CGRectMake(12, APPDELEGATE.customTabbar.height_myNavigationBar + 10, Width - 30, 331)];
    }
