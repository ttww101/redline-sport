...
- (UIWebView *)webView{
    if (!_webView) {
        ...
        [_bridge registerHandler:@"tongpeiList" handler:^(id data, WVJBResponseCallback responseCallback) {
            ...
            TongPeiDetailVC *listWeb = [[TongPeiDetailVC alloc] init];
...
-(void)loadData{
    ...
    [[DCHttpRequest shareInstance] sendHtmlGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_OddsList] Start:^(id requestOrignal) {
