...
@interface SelectedDateTitleView()
...
@end
@implementation SelectedDateTitleView
...
//    }
    ...
    //    if (_isSaiguo) {
    //        [_btnLeft setTitle:@"下一期" forState:UIControlStateNormal];
    //        [_btnLeft setTitle:@"下一期" forState:UIControlStateHighlighted];
    //        [_btnRight setTitle:@"上一期" forState:UIControlStateNormal];
    //        [_btnRight setTitle:@"上一期" forState:UIControlStateHighlighted];
    //
    //    }else{
    //        [_btnLeft setTitle:@"上一期" forState:UIControlStateNormal];
    //        [_btnLeft setTitle:@"上一期" forState:UIControlStateHighlighted];
    ...
    _currentIndex = 0;
    if (_arrData.count>0) {
        QiciModel *qici = [_arrData objectAtIndex:_currentIndex];
