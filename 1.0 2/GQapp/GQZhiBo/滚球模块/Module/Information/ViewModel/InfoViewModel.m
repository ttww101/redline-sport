...
- (void)fetchRecommendedReviewsWithParameter:(NSDictionary *)param
    ...
    [[DCHttpRequest shareInstance]sendGetRequestByMethod:@"get" WithParamaters:param PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,info_url] Start:^(id requestOrignal) {
