...
@end
@implementation BaolengZhishuCell
...
- (void)setModel:(BaolengZishuModel *)model
{
    _model = model;
...
//    _labLeague.textColor = [Methods getColor:_model.sclassColor];
    _labTime.text = [Methods getDateByStyle:dateStyleFormatterMdHm withDate:[NSDate dateWithTimeIntervalSince1970:_model.mtime/1000]];
...
//    _labCompany.text = _model.company;
    ...
    _labBaolengRate.attributedText = [Methods withContent:_labBaolengRate.text WithColorText:@"%" textColor:_labBaolengRate.textColor strFont:font12];
    
    _labHisttoryBaoleng.text = [NSString stringWithFormat:@"历史爆冷%ld场",_model.num];
    
//    _labRateTitleLast.text = @"距上次爆冷";
//    _labRateTitle.text = [NSString stringWithFormat:@"%ld",_model.mostresult];
...
//        make.right.equalTo(self.basicView.mas_right).offset(0);
//        make.centerY.equalTo(self.basicView.mas_centerY).offset(-5);
//        make.width.mas_equalTo(70);
//    }];
//    
//
//    
//    [self.labRateTitleLast mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(self.labRateTitle.mas_bottom).offset(2.5);
//        make.centerX.equalTo(self.labRateTitle.mas_centerX);
//    }];
