...
@property (nonatomic, strong) PeilvViewOfPlyc *peilvView;
@property (nonatomic, assign) BOOL isToFenxi;
@end
@implementation PlycCell
...
- (PeilvViewOfPlyc *)peilvView
{
    if (!_peilvView) {
        _peilvView = [[PeilvViewOfPlyc alloc] init];
    }
    return _peilvView;
}
