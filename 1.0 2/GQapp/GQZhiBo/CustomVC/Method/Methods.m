...
- (void)arrList
{
    ...
    //        LiveScoreModel *model1 = obj1;
    //        LiveScoreModel *model2 = obj2;
...
+ (TokenModel *)getTokenModel
{
    ...
    TokenModel *model = [NSKeyedUnarchiver unarchiveObjectWithFile:[documentsPath stringByAppendingPathComponent:@"token.plist"]];
    return model;
}
...
+ (BOOL)login
{
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:islogin]) {
        ...
        if ([[NSUserDefaults standardUserDefaults] boolForKey:@"thirdPartLogin"]) {
            ...
            NSDate *thirdPartLoginDeadline = [Methods getDateFromString:[[NSUserDefaults standardUserDefaults] objectForKey:@"thirdPartLoginDeadline"] byformat:dateStyleFormatter];
