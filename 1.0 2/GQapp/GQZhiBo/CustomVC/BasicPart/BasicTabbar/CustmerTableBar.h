...
- (void)tabBar:(CustmerTableBar *)tabBar selectedFrom:(NSInteger)from to:(NSInteger)to viewController:(UIViewController *)viewController;

@end

@interface CustmerTableBar : UIView
