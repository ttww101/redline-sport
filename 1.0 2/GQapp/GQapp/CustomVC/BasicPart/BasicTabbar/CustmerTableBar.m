...
@implementation CustmerTableBar
...
- (void)setItemsArr:(NSArray *)itemsArr {
    ...
    TabbarButton *defultSelectBtn = nil;
    for (int i = 0; i < _itemsArr.count; i++) {
        ...
        TabbarButton *tabbar = [[TabbarButton alloc] initWithFrame:CGRectMake(itemsWith * i, 0, itemsWith, self.frame.size.height)];
