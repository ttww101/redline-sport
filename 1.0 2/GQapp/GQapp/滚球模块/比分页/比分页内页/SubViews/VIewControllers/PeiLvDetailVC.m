...
@interface PeiLvDetailVC ()<HSTabBarContentViewDelegate,HSTabBarContentViewDataSource>
...
- (UIView *)tabBarContentView:(HSTabBarContentView *)tabBarContentView contentViewAtIndex:(NSInteger)index {
    ...
    if (self.PeiLvCType == isBeforeTwo) {
        ...
        PeiLvDetailTableVC  *peilvTableVC = [PeiLvDetailTableVC new];
