...
- (void)updateScroeWithmodel:(LiveScoreModel *)liviModel
{
    ...
    if (liviModel.matchstate == -1) {
        ...
        //上半场
        NSString *timeCha =[Methods intervalFromLastDate:liviModel.matchtime2 toTheDate:time];
        ...
        //下半场
        NSString *timeCha =[Methods intervalFromLastDateAnd45:liviModel.matchtime2 toTheDate:time];
        ...
        _labState.text = [Methods getTextByMatchState:liviModel.matchstate];
...
//    //年月日 时 周 分
//    NSArray *arrDate = [Methods getDateByDate:[Methods getDateFromString:_model.matchtime byformat:dateStyleFormatter] withWeekType:weekTypeZhou];
//    
//    
//    
...
//    _labTime.text = [NSString stringWithFormat:@"%@月%@号 %@:%@",arrDate[1],arrDate[2],arrDate[3],timeS];
    ...
    _labTime.text = [Methods getDateByStyle:dateStyleFormatterMdHm withDate:[Methods getDateFromString:_model.matchtime byformat:dateStyleFormatter]];
    ...
    if (_model.matchstate == -1) {
        ...
        //上半场
        NSString *timeCha =[Methods intervalFromLastDate:_model.matchtime2 toTheDate:time];
...
//        _labState.text =@"比赛中";
        ...
        //下半场
        NSString *timeCha =[Methods intervalFromLastDateAnd45:_model.matchtime2 toTheDate:time];
...
//        _labState.text =@"比赛中";
        ...
        _labState.text = [Methods getTextByMatchState:_model.matchstate];
