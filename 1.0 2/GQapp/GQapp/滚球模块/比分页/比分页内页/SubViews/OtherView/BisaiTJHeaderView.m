...
#import "BisaiTHeaderFenxiView.h"
#import "TechtwoModel.h"
@interface BisaiTJHeaderView()

@end
@implementation BisaiTJHeaderView
...
- (void)setArrdata:(NSArray *)arrdata
{
    ...
    for (int i = 0; i<3; i++) {
        ...
        BisaiTJRoundView *round = [[BisaiTJRoundView alloc] initWithFrame:CGRectMake(0, 40, 40, 40)];
    ...
    if (isOniphone6p) {
        BisaiTHeaderFenxiView *headerLeft = [[BisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(20, 90 + 10, 30*4, 25*2)];
        headerLeft.ishome = 0;
        headerLeft.model = home;
        [self addSubview:headerLeft];
        
        
        BisaiTHeaderFenxiView *headerRight = [[BisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(Width - 20 - 30*4, 90 + 10, 30*4, 25*2)];
        ...
        BisaiTHeaderFenxiView *headerLeft = [[BisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(10, 90 + 10, 25*4, 25*2)];
        headerLeft.ishome = 0;
        headerLeft.model = home;
        ...
        BisaiTHeaderFenxiView *headerRight = [[BisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(Width - 10 - 25*4, 90 + 10, 25*4, 25*2)];
        headerRight.ishome = 1;
        headerRight.model = guest;
        ...
        BisaiTHeaderFenxiView *headerLeft = [[BisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(10, 90 + 10, 30*4, 25*2)];
        headerLeft.ishome = 0;
        headerLeft.model = home;
        ...
        BisaiTHeaderFenxiView *headerRight = [[BisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(Width - 10 - 30*4, 90 + 10, 30*4, 25*2)];
        headerRight.ishome = 1;
        headerRight.model = guest;
