...
- (void)loadFenXi{
    ...
    [[DCHttpRequest shareInstance] sendHtmlGetRequestByMethod:@"get" WithParamaters:dict PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_RecordNearList] Start:^(id requestOrignal) {
...
- (void)loadTongjiTezheng
{
    ...
    [[DCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_ServerQiuTan,url_qtapi_zjtz] Start:^(id requestOrignal) {
