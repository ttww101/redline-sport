...
@interface SelecterMatchView()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,UIGestureRecognizerDelegate>
@end
@implementation SelecterMatchView
...
{
    if (_delegate && [_delegate respondsToSelector:@selector(SelecterMatchView:selectedAtIndex:)]) {
        [_delegate SelecterMatchView:self selectedAtIndex:indexPath.row];
    }
}
