...
@interface SelectedSaiGuoTitleView()
...
@end
@implementation SelectedSaiGuoTitleView
...
- (void)setArrData:(NSArray *)arrData
{
    ...
    if (_arrData.count > 0) {
        ...
        QiciModel *qici = [_arrData objectAtIndex:_currentIndex + 1];
        if (_isSaiguo) {
