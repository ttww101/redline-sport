...
#import "SelectedSaiGuoTitleView.h"
#import "DCindexBtn.h"
...
@interface SaiguoViewController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,SelecterDateViewDelegate,SelectedDateTitleViewDelegate,DCindexBtnDelegate,SelectedSaiGuoTitleViewDelegate>
...
@property (nonatomic, strong) SelectedSaiGuoTitleView *saiGuoTitleView;
...
@implementation SaiguoViewController
...
//- (SelectedDTitleView *)dTitleView {
//
//    if (!_dTitleView) {
//        _dTitleView = [[SelectedDTitleView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar + 44, Width, self.seletedHeight)];
//    }
//    return _dTitleView;
//}
...
//    NSArray *tempDataArr = self.dataArr.reverseObjectEnumerator.allObjects;
    ...
    HSDashLineView *lineView = [[HSDashLineView alloc] init];
...
- (SelectedSaiGuoTitleView *)saiGuoTitleView {

    if (!_saiGuoTitleView) {
        _saiGuoTitleView = [[SelectedSaiGuoTitleView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar + 44+14, Width, 39)];
...
{
    if (!_dataTitleView) {
        _dataTitleView = [[SelectedDateTitleView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar + 44+14, Width, 39)];
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerClass:[SaiTableViewCell class] forCellReuseIdentifier:cellSaiguoViewController];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SaiTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellSaiguoViewController];
    if (!cell) {
        cell = [[SaiTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellSaiguoViewController];
    }
