...
#import "BangDanListCell.h"
@interface BangDanTableView()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>


@end


@implementation BangDanTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    BangDanListCell *cell = [tableView dequeueReusableCellWithIdentifier:acell];
    if (!cell) {
        cell = [[BangDanListCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:acell];
    }
