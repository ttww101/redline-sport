...
#import "SelectedViewOfFabuTuijian.h"
...
@property (nonatomic, retain)NSMutableArray *arrPhoto;//保存选中的相片
...
//        _btnConfirm.frame = CGRectMake(15, self.viewZhuma.bottom + 20, Width - 30, 35);
...
//        [_btnConfirm.titleLabel setFont:font17];
//        [_btnConfirm addTarget:self action:@selector(fabuTuijian:) forControlEvents:UIControlEventTouchUpInside];
//        UIView *lineView  = [[UIView alloc] initWithFrame:CGRectMake(0, self.btnConfirm.top - 15, Width, 0.5)];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [[UMStatisticsMgr sharedInstance] viewStaticsEndWithMarkStr:@"RelRecNewVC"];
}
- (void)setupModel:(Dan_StringMatchsModel *)model{
    _model = model;
...
//        [_titleView updateSelectedIndex:0];
     
        DxModel *dxModel = model.spf[0];
//         _play = @"spf";
...
//         _playContent = [NSString stringWithFormat:@"[%@,\"%@\",%@]",dxModel.UpOdds,dxModel.Goal,dxModel.DownOdds];
        ...
        [self.btnOne setAttributedTitle:[Methods withContent:self.btnOne.titleLabel.text WithContColor:colorEa WithContentFont:font15 WithText:@"胜" WithTextColor:colorf66666 WithTextFont:font15] forState:UIControlStateNormal];
        [self.btnOne setAttributedTitle:[Methods withContent:self.btnOne.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font15 WithText:self.btnOne.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font15] forState:UIControlStateSelected];
      
        [self.btnTwo setTitle:[NSString stringWithFormat:@"平        %.2f",[dxModel.Goal floatValue]] forState:UIControlStateNormal];
        [self.btnTwo setAttributedTitle:[Methods withContent:self.btnTwo.titleLabel.text WithContColor:colorEa WithContentFont:font15 WithText:@"平" WithTextColor:colorf66666 WithTextFont:font15] forState:UIControlStateNormal];
        [self.btnTwo setAttributedTitle:[Methods withContent:self.btnTwo.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font15 WithText:self.btnTwo.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font15] forState:UIControlStateSelected];
//        self.btnTwo.layer.borderColor = colorDD.CGColor;
//        [self.btnTwo setBackgroundImage:[UIImage imageNamed:@"tuijianDTPeilv"] forState:UIControlStateNormal];
      
        [self.btnThree setTitle:[NSString stringWithFormat:@"负        %.2f",[dxModel.DownOdds floatValue]] forState:UIControlStateNormal];
        [self.btnThree setAttributedTitle:[Methods withContent:self.btnThree.titleLabel.text WithContColor:colorEa WithContentFont:font15 WithText:@"负" WithTextColor:colorf66666 WithTextFont:font15] forState:UIControlStateNormal];
        [self.btnThree setAttributedTitle:[Methods withContent:self.btnThree.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font15 WithText:self.btnThree.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font15] forState:UIControlStateSelected];
...
//        _play = @"ya";
        ...
        [self.btnZhu setAttributedTitle:[Methods withContent:self.btnZhu.titleLabel.text WithContColor:colorEa WithContentFont:font15 WithText:@"主" WithTextColor:colorf66666 WithTextFont:font15] forState:UIControlStateNormal];
        [self.btnZhu setAttributedTitle:[Methods withContent:self.btnZhu.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font15 WithText:self.btnZhu.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font15] forState:UIControlStateSelected];
        ...
        [self.btnKe setAttributedTitle:[Methods withContent:self.btnKe.titleLabel.text WithContColor:colorEa WithContentFont:font15 WithText:@"客" WithTextColor:colorf66666 WithTextFont:font15] forState:UIControlStateNormal];
        [self.btnKe setAttributedTitle:[Methods withContent:self.btnKe.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font15 WithText:self.btnKe.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font15] forState:UIControlStateSelected];
...
//        _play = @"dx";
        ...
        [self.btnBig setAttributedTitle:[Methods withContent:self.btnBig.titleLabel.text WithContColor:colorEa WithContentFont:font15 WithText:@"大" WithTextColor:colorf66666 WithTextFont:font15] forState:UIControlStateNormal];
        [self.btnBig setAttributedTitle:[Methods withContent:self.btnBig.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font15 WithText:self.btnBig.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font15] forState:UIControlStateSelected];
        ...
        [self.btnLittle setAttributedTitle:[Methods withContent:self.btnLittle.titleLabel.text WithContColor:colorEa WithContentFont:font15 WithText:@"小" WithTextColor:colorf66666 WithTextFont:font15] forState:UIControlStateNormal];
        [self.btnLittle setAttributedTitle:[Methods withContent:self.btnLittle.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font15 WithText:self.btnLittle.titleLabel.text WithTextColor:[UIColor whiteColor] WithTextFont:font15] forState:UIControlStateSelected];
    ...
    if (model.spf.count == 0) {
        ...
        self.rqBaseView.frame = CGRectMake(0,  10, Width, 44+20+20); //self.nav.bottom +
...
//        [self.ScrollView layoutIfNeeded];
    ...
    else if (model.spf.count == 0 && model.rq.count > 0){
        _titleView.selectedIndex = 1;
        [_titleView updateSelectedIndex:1];
        DxModel *dxModel = model.rq[0];
        _play = @"ya";
        _playContent = [NSString stringWithFormat:@"[%@,\"%@\",%@]",dxModel.UpOdds,dxModel.Goal,dxModel.DownOdds];
        [self.btnOne setTitle:[NSString stringWithFormat:@"主        %.2f",[dxModel.UpOdds floatValue]] forState:UIControlStateNormal];
        self.btnTwo.enabled = NO;
        [self.btnTwo setTitle:[NSString stringWithFormat:@"%@",dxModel.Goal] forState:UIControlStateNormal];
        [self.btnTwo setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
        self.btnTwo.layer.borderColor = [UIColor clearColor].CGColor;
        
        
        [self.btnThree setTitle:[NSString stringWithFormat:@"客        %.2f",[dxModel.DownOdds floatValue]] forState:UIControlStateNormal];
    }else if(model.spf.count == 0 && model.rq.count == 0 && model.dx.count > 0){
        _titleView.selectedIndex = 2;
        [_titleView updateSelectedIndex:2];
        DxModel *dxModel = model.dx[0];
        _play = @"dx";
        _playContent = [NSString stringWithFormat:@"[%@,\"%@\",%@]",dxModel.UpOdds,dxModel.Goal,dxModel.DownOdds];
        [self.btnOne setTitle:[NSString stringWithFormat:@"主        %.2f",[dxModel.UpOdds floatValue]] forState:UIControlStateNormal];
    ...
    if (model.spf.count == 0) {
         [_titleView selectedEndNO:0];
    }
    if (model.rq.count == 0) {
         [_titleView selectedEndNO:1];
    }
    if (model.dx.count == 0) {
         [_titleView selectedEndNO:2];
    }
     */
...
- (void)didSelectedAtIndex:(NSInteger)index
{
    ...
    switch (index) {
        case 0:{
            _play = @"spf";
            DxModel *dxModel = self.model.spf[0];
        ...
        case 1:{
            _play = @"ya";
            DxModel *dxModel = self.model.rq[0];
           _playContent = [NSString stringWithFormat:@"[%@,\"%@\",%@]",dxModel.UpOdds,dxModel.Goal,dxModel.DownOdds];
            [self.btnOne setTitle:[NSString stringWithFormat:@"主        %.2f",[dxModel.UpOdds floatValue]] forState:UIControlStateNormal];
            self.btnTwo.enabled = NO;
            [self.btnTwo setTitle:[NSString stringWithFormat:@"%@",dxModel.Goal] forState:UIControlStateNormal];
        ...
        case 2:{
            _play = @"dx";
            DxModel *dxModel = self.model.dx[0];
            _playContent = [NSString stringWithFormat:@"[%@,\"%@\",%@]",dxModel.UpOdds,dxModel.Goal,dxModel.DownOdds];
            [self.btnOne setTitle:[NSString stringWithFormat:@"大        %.2f",[dxModel.UpOdds floatValue]] forState:UIControlStateNormal];
            self.btnTwo.enabled = NO;
            [self.btnTwo setTitle:[NSString stringWithFormat:@"%@",dxModel.Goal] forState:UIControlStateNormal];
            [self.btnTwo setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
            self.btnTwo.layer.borderColor = [UIColor clearColor].CGColor;
            [self.btnThree setTitle:[NSString stringWithFormat:@"小        %.2f",[dxModel.DownOdds floatValue]] forState:UIControlStateNormal];
        }
...
//        }else{
//            
//            [self fabuTuijianWithHtml:@"" withContent:_textView.text];
//        }
        //
...
{
    if (!_ScrollView) {
//        _ScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, _titleView.bottom, Width, Height -_titleView.bottom)];
        _ScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, _nav.bottom, Width, Height -_nav.bottom)];
        _ScrollView.backgroundColor = [UIColor whiteColor];
//        _ScrollView.backgroundColor = redcolor;
...
//        [_ScrollView addSubview:self.viewDescribe];
        [_ScrollView addSubview:self.viewZhuma];
//        [_ScrollView addSubview:self.btnConfirm];
//        _ScrollView.contentSize = CGSizeMake(Width, _ViewTextTitle.bottom + _textViewHeight + self.viewDescribe.height + 10 + self.viewZhuma.height+ 15 + self.btnConfirm.height + 20 + 15 );
//        _ScrollView.contentSize = CGSizeMake(Width, _ViewTextTitle.bottom + _textViewHeight + self.viewDescribe.height + 10 + self.viewZhuma.height+ 15 + 20 + 15 );
...
//        [_rqBaseView addSubview:self.labDXQ];
//        [_rqBaseView addSubview:self.btnBig];
//        [_rqBaseView addSubview:self.btnLittle];
    }
    return _rqBaseView;
}
...
- (UIButton *)btnZhu {
    ...
    if (!_btnZhu) {
        ...
        //        [_btnOne setAttributedTitle:[Methods withContent:_btnOne.titleLabel.text WithContColor:color66 WithContentFont:font14 WithText:@"胜" WithTextColor:color33 WithTextFont:font16] forState:UIControlStateNormal];
        //
        //        [_btnOne setAttributedTitle:[Methods withContent:_btnOne.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font14 WithText:@"胜" WithTextColor:[UIColor whiteColor] WithTextFont:font16] forState:UIControlStateSelected];
...
//        _viewDetial.backgroundColor = colorTableViewBackgroundColor;
...
//            case 0:
//            {
//                _viewDetial = [[UIView alloc] initWithFrame:CGRectMake(0, _viewDetialTitle.bottom, Width, 15 + _model.spf.count*(30 + 12))];
//                [_model.spf enumerateObjectsUsingBlock:^(DxModel* _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
//                    
//                    SelectedViewOfFabuTuijian *selectedView = [[SelectedViewOfFabuTuijian alloc] initWithFrame:CGRectMake(0, 15 + (30 + 12)*idx, Width, 30)];
//                    selectedView.companyIndex = idx;
//                    selectedView.newTypeNum = _newTypeNum;
//                    selectedView.model = obj;
//                    selectedView.delegate = self;
//                    if ([obj.company isEqualToString:_model.spfcompany]) {
//                        [selectedView setCurrentIndex:_oddsNum];
//                    }
//                    [_viewDetial addSubview:selectedView];
//                    [_arrSelectedView addObject:selectedView];
//                }];
//                
//            }
//                break;
//            case 1:
//            {
//                _viewDetial = [[UIView alloc] initWithFrame:CGRectMake(0, _viewDetialTitle.bottom, Width, 15 + _model.rq.count*(30 + 12))];
//                [_model.rq enumerateObjectsUsingBlock:^(DxModel* _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
//                    
//                    SelectedViewOfFabuTuijian *selectedView = [[SelectedViewOfFabuTuijian alloc] initWithFrame:CGRectMake(0, 15 + (30 + 12)*idx, Width, 30)];
//                    selectedView.companyIndex = idx;
//
...
//                    selectedView.delegate = self;
//
//                    if ([obj.company isEqualToString:_model.rqcompany]) {
//                        [selectedView setCurrentIndex:_oddsNum];
//                    }
//                    [_viewDetial addSubview:selectedView];
//                    [_arrSelectedView addObject:selectedView];
...
//            case 2:
//            {
//                _viewDetial = [[UIView alloc] initWithFrame:CGRectMake(0, _viewDetialTitle.bottom, Width, 15 + _model.dx.count*(30 + 12))];
//                [_model.dx enumerateObjectsUsingBlock:^(DxModel* _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
//                    
//                    SelectedViewOfFabuTuijian *selectedView = [[SelectedViewOfFabuTuijian alloc] initWithFrame:CGRectMake(0, 15 + (30 + 12)*idx, Width, 30)];
//                    selectedView.companyIndex = idx;
//                    selectedView.newTypeNum = _newTypeNum;
...
//                    selectedView.delegate = self;
//
//                    if ([obj.company isEqualToString:_model.dxcompany]) {
//                        [selectedView setCurrentIndex:_oddsNum];
//                    }
//                    [_viewDetial addSubview:selectedView];
//                    [_arrSelectedView addObject:selectedView];
...
//                break;
//        }
//        _viewDetial.backgroundColor = grayColor2;
    }
    return _viewDetial;
}
- (UIButton *)btnOne{
...
//        _btnOne.titleLabel.attributedText = [Methods withContent:_btnOne.titleLabel.text WithColorText:@"胜" textColor:color66 strFont:BoldFont6(fontSize14)];
    }
    return _btnOne;
}
...
//        [_btnTwo setTitle:[NSString stringWithFormat:@"平        %@",self.model.spf[0][@"goal"]] forState:UIControlStateNormal];
...
//        _btnTwo.titleLabel.attributedText = [Methods withContent:_btnTwo.titleLabel.text WithColorText:@"胜" textColor:color66 strFont:BoldFont6(fontSize14)];
    }
    return _btnTwo;
}
...
//        [_btnThree setTitle:[NSString stringWithFormat:@"负        %@",self.model.spf[0][@"downodds"]] forState:UIControlStateNormal];
...
//        _btnThree.titleLabel.attributedText = [Methods withContent:_btnThree.titleLabel.text WithColorText:@"胜" textColor:color66 strFont:BoldFont6(fontSize14)];
    }
    return _btnThree;
}
...
//    _choice = [NSString stringWithFormat:@"%ld",btn.tag];
    DxModel *dxModel;
//    if ([_play isEqualToString:@"spf"]) {
//        dxModel = self.model.spf[0];
//    }else if([_play isEqualToString:@"rq"]){
...
{
    NSLog(@"selectedModel----%@ %ld",selectedModel,index);
    switch (index) {
        case 3:
        {
            _choiceMultiple = selectedModel.UpOdds;
        }
            break;
        case 1:
        {
            _choiceMultiple = selectedModel.Goal;

        }
            break;
        case 0:
        {
            _choiceMultiple = selectedModel.DownOdds;
    ...
    _choice = [NSString stringWithFormat:@"%ld",index];
    _playContent = [NSString stringWithFormat:@"[%@,\"%@\",%@]",selectedModel.UpOdds,selectedModel.Goal,selectedModel.DownOdds];
    switch (_newTypeNum) {
        case 0:
        {
            _play = @"spf";
    ...
    [_arrSelectedView enumerateObjectsUsingBlock:^(SelectedViewOfFabuTuijian *_Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        
        if (obj.companyIndex != companyIndex) {
            [obj clearbackGroundImage];
        }
    }];
}
...
- (ZhumaViewOfFabuTuijian *)viewZhuma
{
    if (!_viewZhuma) {
        _viewZhuma = [[ZhumaViewOfFabuTuijian alloc] initWithFrame:CGRectMake(0, self.textView.bottom + 20, Width, 145)];
        _viewZhuma.delegate = self;
        
//        _viewZhuma.backgroundColor = redcolor;
    }
    return _viewZhuma;
}
...
//    NSLog(@"mutiple - %f",[_multiple doubleValue]);
...
//{
//    if (!_viewDescribe) {
//        _viewDescribe = [[UIView alloc] init];
////        _viewDescribe.backgroundColor = colorTableViewBackgroundColor;
//        NSString *text = @"分析内容与本场比赛无关、滥用标点符号、留联系方式或发布其他违规内容，以及被发现有抄袭行为者，将直接取消分析师资格！";
//        CGFloat textheight = [text boundingRectWithSize:CGSizeMake(Width - 50, MAXFLOAT) font:font12 lineSpacing:6].height;
//        _viewDescribe.frame = CGRectMake(0,_textView.bottom + 10, Width, textheight);
//        UIImageView *imageV = [[UIImageView alloc] initWithFrame:CGRectMake(15, 0, 15, 15)];
//        imageV.image = [UIImage imageNamed:@"tuijianDescripe"];
//        [_viewDescribe addSubview:imageV];
//        
//        UILabel *labText = [[UILabel alloc] initWithFrame:CGRectMake(15 + 15 + 5 , 0, Width - 50, textheight)];
//        labText.font = font12;
//        labText.textColor = color99;
//        labText.numberOfLines = 0;
//        labText.attributedText = [text lineTextboundingRectWithSize:CGSizeMake(Width - 50, MAXFLOAT) font:font12 lineSpacing:6];
//        [_viewDescribe addSubview:labText];
//        
//        
//        
//    }
//    return _viewDescribe;
//}
...
- (UILabel *)textViewPlaceholder
{
    if (!_textViewPlaceholder) {
        ...
        _textViewPlaceholder.attributedText = [Methods setTextStyleWithString:@"推荐内容需原创，请提供详细分析或盘赔解读，涉及广告、抄袭等违规或过于简单将取消分析师资格哦！" WithLineSpace:4 WithHeaderIndent:0];
    }
...
//        _textView.textColor = grayColor3;
//        
//    }else{
//        textView.text = @"......";
//        _textView.textColor = grayColor34;
//        
//    }
//    CGRect frame = textView.frame;
//    CGSize constraintSize = CGSizeMake(frame.size.width, MAXFLOAT);
...
//        
//        NSDictionary *attributes = @{NSFontAttributeName:font16,
...
//        _viewDescribe.frame = CGRectMake( _viewDescribe.x,_textView.bottom + 10, _viewDescribe.width, _viewDescribe.height);
//        _viewZhuma.frame = CGRectMake(0, _viewDescribe.bottom + 15, Width, 145);
        _viewZhuma.frame = CGRectMake(0, _textView.bottom + 15, Width, 145);

        //        _btnConfirm.frame = CGRectMake(15, _viewZhuma.bottom + 20, Width - 30, 35);
//        _ScrollView.contentSize = CGSizeMake(Width, _ViewTextTitle.bottom + _textViewHeight + self.viewDescribe.height + 10 + self.viewZhuma.height+ 15 + self.btnConfirm.height + 20 + 15 );
//        _ScrollView.contentSize = CGSizeMake(Width, _ViewTextTitle.bottom + _textViewHeight + self.viewDescribe.height + 10 + self.viewZhuma.height+ 15  + 20 + 15 );
        
         _ScrollView.contentSize = CGSizeMake(Width, _ViewTextTitle.bottom + _textViewHeight + 10 + self.viewZhuma.height+ 15  + 20 + 15 );
        if (self.ScrollView.contentSize.height >self.ScrollView.height) {
//            [self.ScrollView setContentOffset:CGPointMake(0, self.ScrollView.contentSize.height - self.ScrollView.height - (self.viewDescribe.height + 10 + self.viewZhuma.height+ 15 + self.btnConfirm.height + 20 + 15 ))];
//            [self.ScrollView setContentOffset:CGPointMake(0, self.ScrollView.contentSize.height - self.ScrollView.height - (self.viewDescribe.height + 10 + self.viewZhuma.height+ 15 +  20 + 15 ))];
...
//            self.ScrollView.frame = CGRectMake(0, _titleView.bottom, Width, Height - keyboardHeight  - _titleView.bottom - self.buttomView.height );
...
- (void)KeyboardHide:(NSNotification *)notification
{
    ...
    [UIView animateWithDuration:keyboardDuration animations:^{
//        self.ScrollView.frame = CGRectMake(0, _titleView.bottom, Width, Height - _titleView.bottom);
...
//        _ScrollView.contentSize = CGSizeMake(Width, _ViewTextTitle.bottom + size.height + self.viewDescribe.height + 10);
...
- (void)uploadImage{
   /* NSMutableDictionary *parameter = [NSMutableDictionary dictionaryWithDictionary:[HttpString getCommenParemeter]];
    ...
    //    [DCHttpRequest shareInstance].contentType = @"multipart/form-data";
    [[DCHttpRequest shareInstance] sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_upLoadImg,url_feedBack_upLoadImg] ArrayFile:[NSArray arrayWithObjects:_image, nil]  FileName:@"imagefile"
    ...
    [[DCHttpRequest shareInstance] sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_ZiXunUrl] ArrayFile:[_textView.attributedText getImgaeArray] Start:^(id requestOrignal) {
        //        [self.textView.attributedText getImgaeArray]
    } End:^(id responseOrignal) {
...
- (void)getPPP:(NSString *)strHTML{
    NSArray *arrayOne = [strHTML componentsSeparatedByString:@"<body>"];//匹配得到的下标
...
- (void)fabuTuijianWithHtml:(NSString *)htmlStr withContent:(NSString *)contentStr
{
    ...
    [[DCHttpRequest shareInstance] sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server, url_addrecommend] ArrayFile:nil Start:^(id requestOrignal) {
        ...
        if ([[responseOrignal objectForKey:@"code"] isEqualToString:@"200"]) {
//            [SVProgressHUD showImage:[UIImage imageNamed:@""] status:@"发布成功，请去大厅或个人中心查看"];
...
//            [self.navigationController popViewControllerAnimated:YES];
            ...
            FaBuSucceedVCViewController *fabuVC = [FaBuSucceedVCViewController new];
...
- (void)updateModel
{
    ...
    [[DCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_SingalRecommendMatch] Start:^(id requestOrignal) {
        ...
        if ([[responseOrignal objectForKey:@"code"] isEqualToString:@"200"]) {
            ...
            _model.rq = [DxModel arrayOfEntitiesFromArray:[[[responseOrignal objectForKey:@"data"] objectForKey:@"instantOdds"] objectForKey:@"rq"]];
            _model.spf = [DxModel arrayOfEntitiesFromArray:[[[responseOrignal objectForKey:@"data"] objectForKey:@"instantOdds"] objectForKey:@"spf"]];
            _model.dx = [DxModel arrayOfEntitiesFromArray:[[[responseOrignal objectForKey:@"data"] objectForKey:@"instantOdds"] objectForKey:@"dx"]];
            _model.priceList = [PriceListModel arrayOfEntitiesFromArray:[[responseOrignal objectForKey:@"data"] objectForKey:@"priceList"]];
