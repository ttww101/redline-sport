...
@implementation GQMineTableViewCell
...
+ (GQMineTableViewCell *)cellForTableView:(UITableView *)tableView {
    GQMineTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[GQMineTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
