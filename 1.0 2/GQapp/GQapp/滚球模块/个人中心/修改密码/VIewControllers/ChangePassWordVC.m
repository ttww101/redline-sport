...
- (void)ConfireBtnRequest
{
    ...
    [parameter setObject:[Methods md5WithString:self.txtOldNum.text] forKey:@"oldpsw"];
    [parameter setObject:[Methods md5WithString:self.txtNewNum.text] forKey:@"newpsw"];
