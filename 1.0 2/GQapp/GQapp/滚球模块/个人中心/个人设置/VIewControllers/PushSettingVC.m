...
- (void)requestPushSetting
{
    ...
    [[DCHttpRequest shareInstance] sendRequestByMethod:@"post"  WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_push_setting]  ArrayFile:nil Start:^(id requestOrignal) {
...
- (void)loadPushIndex
{
    ...
    [[DCHttpRequest shareInstance] sendRequestByMethod:@"post"  WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_push_index]  ArrayFile:nil Start:^(id requestOrignal) {
