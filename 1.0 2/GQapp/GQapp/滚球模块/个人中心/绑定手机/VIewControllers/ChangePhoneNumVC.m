...
@property (nonatomic, strong)JKCountDownButton *btn;//获取验证码的按钮
...
- (JKCountDownButton *)btn{
    if (!_btn) {
        _btn = [JKCountDownButton buttonWithType:UIButtonTypeCustom];
...
//        _btn.titleLabel.attributedText = [Methods withContent:_btn.titleLabel.text WithContColor:color33 WithContentFont:font14 WithText:_btn.titleLabel.text  WithTextColor:redcolor WithTextFont:font14];
    }
    return _btn;
}
