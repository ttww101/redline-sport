...
- (void)setModel:(NavigationModel *)model{
    ...
    self.labLeague.textColor = [Methods getColor:model.leagueColor];
    self.labTime.text = [NSString stringWithFormat:@"%@",[Methods getDateByStyle:dateStyleFormatterMdHm withDate:[NSDate dateWithTimeIntervalSince1970:[model.matchtime doubleValue]/1000]]];
