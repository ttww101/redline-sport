...
#import "QBNavigatCell.h"
#import "NavigationModel.h"
#import "FenxiPageVC.h"
#import "LiveScoreModel.h"

@interface QBNavigationVC ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[UMStatisticsMgr sharedInstance] viewStaticsBeginWithMarkStr:@"QBNavigationVC"];
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    [[UMStatisticsMgr sharedInstance] viewStaticsEndWithMarkStr:@"QBNavigationVC"];
}
...
- (void)loadData
{
    ...
    [[DCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,@"/mobile/news/fullList"] Start:^(id requestOrignal) {
        ...
        if ([[responseOrignal objectForKey:@"code"] isEqualToString:@"200"]) {
            ...
            _arrAllDate = [[NSMutableArray alloc] initWithArray:[NavigationModel arrayOfEntitiesFromArray: [responseOrignal objectForKey:@"data"]]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    QBNavigatCell *cell = [tableView dequeueReusableCellWithIdentifier:aCell];
    if (!cell) {
        cell = [[QBNavigatCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:aCell];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NavigationModel *model = _arrAllDate[indexPath.row];
