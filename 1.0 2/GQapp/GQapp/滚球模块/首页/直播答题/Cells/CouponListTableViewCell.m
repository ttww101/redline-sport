...
@interface CouponListTableViewCell ()
...
+ (CouponListTableViewCell *)cellForTableView:(UITableView *)tableView {
    CouponListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[CouponListTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
...
- (void)refreshContentData:(id)model {
    CouponModel *dataMode = (CouponModel *)model;
