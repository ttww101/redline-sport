...
@property (nonatomic , strong) LiveQuizAlertView *isaView;
...
@implementation LiveQuizAlertView
...
+ (instancetype)showPaymentInfo:(id)information
    ...
    static LiveQuizAlertView *payView = nil;
    if (!payView) {
        payView = [[LiveQuizAlertView alloc]initWithFrame:windowView.bounds];
    }
