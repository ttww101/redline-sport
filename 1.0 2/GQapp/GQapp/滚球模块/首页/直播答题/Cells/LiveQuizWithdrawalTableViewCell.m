//
//  LiveQuizWithdrawalTableViewCell.m
//  newGQapp
//
...
#import "LiveQuizWithdrawalTableViewCell.h"

@interface LiveQuizWithdrawalTableViewCell ()
...
@implementation LiveQuizWithdrawalTableViewCell
...
+ (LiveQuizWithdrawalTableViewCell *)cellForTableView:(UITableView *)tableView {
    LiveQuizWithdrawalTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[LiveQuizWithdrawalTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
