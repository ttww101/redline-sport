...
@implementation UniversaListCell
...
+ (UniversaListCell *)cellForTableView:(UITableView *)tableView {
    UniversaListCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[UniversaListCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
