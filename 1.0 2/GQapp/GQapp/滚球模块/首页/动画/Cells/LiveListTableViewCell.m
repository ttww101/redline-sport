...
+ (LiveListTableViewCell *)cellForTableView:(UITableView *)tableView {
    LiveListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        cell = [[LiveListTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
...
- (void)refreshContentData:(LiveListModel *)model {
    self.matchTimeLabel.text = [Methods formatHHSSStamp:model.startTime];
    ...
    [self.homeTermIcon sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://ls.sportradar.com/ls/crest/small/%@.png",model.homeUid]] placeholderImage:[Methods defaultPlaceHolderImage:@"default_home_icon"]];
    [self.VisitingTermIcon sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://ls.sportradar.com/ls/crest/small/%@.png",model.awayUid]] placeholderImage:[Methods defaultPlaceHolderImage:@"default_home_icon"]];
