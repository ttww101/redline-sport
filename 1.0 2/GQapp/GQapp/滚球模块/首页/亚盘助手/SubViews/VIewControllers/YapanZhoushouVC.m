...
#import "YpasCell.h"
#import "YpasTwoCell.h"
#define  cellYpasCell @"cellYpasCell"
#define  cellYpasTwoCell @"cellYpasTwoCell"
@interface YapanZhoushouVC ()<TitleIndexViewDelegate,PlycSelectedViewdelegate,UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
...
@implementation YapanZhoushouVC
...
//    }
    ...
    [[DCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,_typeOdd == 0? url_letgoalAbnormalindex :url_totalAbnormalindex] Start:^(id requestOrignal) {
...
{
    if (!_tableView) {
        _tableView = [[BasicTableView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar + 48 + 10, Width, Height - APPDELEGATE.customTabbar.height_myNavigationBar - 48 - 10) style:UITableViewStylePlain];
        _tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
        _tableView.showsVerticalScrollIndicator = NO;
        [_tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"cell"];
        [_tableView registerClass:[YpasCell class] forCellReuseIdentifier:cellYpasCell];
        [_tableView registerClass:[YpasTwoCell class] forCellReuseIdentifier:cellYpasTwoCell];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (_currentIndex == 0) {
        ...
        PlycModel *mod = [_arrdata objectAtIndex:indexPath.row];
...
{
    if (_currentIndex == 0) {
        YpasCell *cell = [tableView dequeueReusableCellWithIdentifier:cellYpasCell];
        if (!cell) {
            cell = [[YpasCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellYpasCell];
        }
        ...
        YpasTwoCell *cell = [tableView dequeueReusableCellWithIdentifier:cellYpasTwoCell];
        if (!cell) {
            cell = [[YpasTwoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellYpasTwoCell];
        }
        cell.selectionStyle = UITableViewCellSelectionStyleNone;
