...
@implementation PeilvViewofYapsCell
...
- (void)setModel:(PlycModel *)model
{
    ...
    if (!isNUll(_model.finalTimeCn)&& ![_model.finalTimeCn isEqualToString:@"全部"]) {
        ...
        _labTimeJP.text = [Methods timeToNowWith:_model.finalTime];
    ...
    _labTimeCP.text = [Methods timeToNowWith:_model.firstTime];
...
//    }
    ...
    for (int i = 0; i<_model.panProcess.count; i++) {
        ...
        PanProcessModel *process = [_model.panProcess objectAtIndex:i];
...
//        lab3.text = @"1.3";
       ...
       UILabel *labTime = [[UILabel alloc] initWithFrame:CGRectMake(lab3.right + 8.5, 0, 50, 10)];
        ...
        labTime.font = font7;
        labTime.text = [Methods timeToNowWith:process.modifyTime];
