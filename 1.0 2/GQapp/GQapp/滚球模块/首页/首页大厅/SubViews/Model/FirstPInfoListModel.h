...
@interface FirstPInfoListModel : BasicModel
...
@property (nonatomic, strong) DxModel *ya;
@property (nonatomic, strong) DxModel *spf;
@property (nonatomic, strong) DxModel *dx;
