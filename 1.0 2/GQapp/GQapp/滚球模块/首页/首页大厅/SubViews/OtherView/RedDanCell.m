...
- (void)setModel:(RedDanModel *)model{
    _model = model;
    ...
    self.labSL.attributedText = [Methods withContent:self.labSL.text WithColorText:@"%" textColor:redcolor strFont:font17];
    ...
    self.labTime.text = [NSString stringWithFormat:@"%@",[Methods getDateByStyle:@"MM-dd" withDate:[NSDate dateWithTimeIntervalSince1970:[model.matchTime doubleValue]/1000]]];
