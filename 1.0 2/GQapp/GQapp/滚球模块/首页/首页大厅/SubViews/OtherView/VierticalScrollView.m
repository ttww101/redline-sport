...
//        NSMutableAttributedString *attributeString = [Methods withContent:btn.titleLabel.text WithColorText:@"" textColor:color33 strFont:font12];
//        
...
//    NSMutableAttributedString *attributeString = [Methods withContent:modelBtn.titleLabel.text WithColorText:@"" textColor:color33 strFont:font12];
//    
//    [attributeString setAttributes:@{NSForegroundColorAttributeName : redcolor,   NSFontAttributeName : font12} range:NSMakeRange(0, 4)];
//    
