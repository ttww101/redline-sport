...
- (void)setModel:(FirstPInfoListModel *)model{
    _model = model;
    self.labLeague.text = model.league;
    self.labTime.text = [Methods getDateByStyle:dateStyleFormatterMdHm withDate:[NSDate dateWithTimeIntervalSince1970:model.matchtime/1000]];
...
//    }
    ...
    [self.labContent setAttributedText:[Methods setTextStyleWithString:model.matchintro WithLineSpace:6 WithHeaderIndent:0]];
    if (model.info > 0) {
    ...
    if (_model.matchstate == -1) {
        ...
        self.labMiao.text = [Methods getTextByMatchState:_model.matchstate];
