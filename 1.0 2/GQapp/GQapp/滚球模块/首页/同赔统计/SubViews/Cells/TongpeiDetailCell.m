...
@end
@implementation TongpeiDetailCell
...
- (void)setModel:(TongPeiMatchModel *)model
{
    _model = model;
    ...
    _labWin.backgroundColor = [Methods getColor:_model.resultColor];
