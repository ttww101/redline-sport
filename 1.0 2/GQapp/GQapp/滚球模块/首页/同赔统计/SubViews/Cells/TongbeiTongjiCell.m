...
@end
@implementation TongbeiTongjiCell
...
- (void)setModel:(TongPeiTJModel *)model
{
    _model = model;
...
//    }
    ...
    _labRate.textColor = [Methods getColor:_model.resultColor];
    _labRateTitle.textColor = [Methods getColor:_model.resultColor];
    _labRound.text = [NSString stringWithFormat:@"共%ld场",_model.num];
    _labRound.textColor =color66;
    _labRate.attributedText = [Methods withContent:_labRate.text WithColorText:@"%" textColor:[Methods getColor:_model.resultColor] strFont:font12];
