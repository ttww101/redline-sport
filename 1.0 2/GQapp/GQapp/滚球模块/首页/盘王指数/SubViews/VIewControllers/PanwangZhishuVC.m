...
@interface PanwangZhishuVC ()<TitleIndexViewDelegate,UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation PanwangZhishuVC
...
- (void)viewDidLoad {
    ...
    [mainView registerClass:[PanwangCollectCell class] forCellWithReuseIdentifier:cellPanwangCollect];
...
{
    PanwangCollectCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellPanwangCollect forIndexPath:indexPath];
