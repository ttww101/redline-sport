...
#import "ZBDCPhotoView.h"

#define screen_width [UIScreen mainScreen].bounds.size.width
#define screen_height [UIScreen mainScreen].bounds.size.height
@interface ZBDC_JZAPhotoVC ()<UIScrollViewDelegate,PhotoViewDelegate>
{
    CGFloat lastScale;
...
@implementation ZBDC_JZAPhotoVC
