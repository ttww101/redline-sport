...
@implementation ZBJKCountDownButton
...
-(void)touched:(ZBJKCountDownButton*)sender{
...
//        _second--;
        if (_didChangeBlock)
        {
            ...
            [self setAttributedTitle:[ZBMethods withContent:_didChangeBlock(self,_second) WithContColor:color33 WithContentFont:font14 WithText:[NSString stringWithFormat:@"%ds",_second] WithTextColor:redcolor WithTextFont:font14] forState:UIControlStateNormal];
...
- (void)stop{
    ...
    {
        self.enabled = YES;
        [self setAttributedTitle:[ZBMethods withContent:@"重新获取" WithContColor:color33 WithContentFont:font14 WithText:@"" WithTextColor:redcolor WithTextFont:font14] forState:UIControlStateNormal];
