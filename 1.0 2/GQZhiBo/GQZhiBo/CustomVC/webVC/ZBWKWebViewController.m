...
#import "ZBWKWebViewController.h"
#import <WebKit/WebKit.h>
@interface ZBWKWebViewController ()<UIWebViewDelegate,UIActionSheetDelegate,WKNavigationDelegate>
{
    ZBLMJScrollTextView * _scrollTextView1;
...
@implementation ZBWKWebViewController
...
- (void)setNavView
{
    ...
    if ([ZBMethods getTextWidthSize:_strtitle strfont:font18] >(Width - 44*2 - 30*2)) {
        
        nav.labTitle.hidden = YES;
        _scrollTextView1 = [[ZBLMJScrollTextView alloc] initWithFrame:CGRectMake(0, 0, (Width - 44*2 - 30*2), 44) textScrollModel:LMJTextScrollContinuous direction:LMJTextScrollMoveLeft];
