...
- (NSArray *)loadLocalTableBarConfig {
    NSDictionary *gameTabBarItemsAttributes = [self tableBarItemControllerName:@"ZBBifenViewController" title:@"赛事" defaultImage:@"bifen" selectImage:@"bifen-1"];
    NSDictionary *newsTabBarItemsAttributes = [self tableBarItemControllerName:@"ZBNewQingBaoViewController" title:@"资讯" defaultImage:@"qingbao" selectImage:@"qingbao-1"];
...
//    model.webUrl = [NSString stringWithFormat:@"file://%@", path];
    ...
    ZBWebModel *expertModel = [[ZBWebModel alloc]init];
    ...
    NSDictionary *aboutMeTabBarItemsAttributes = [self tableBarItemControllerName:@"ZBMineViewController" title:@"我的" defaultImage:@"wode" selectImage:@"wode-1"];
