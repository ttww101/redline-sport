...
#import "ZBPlycPeilvView.h"
#import "ZBPlycSelectedView.h"
@interface ZBPeilvYichangVC ()<TitleIndexViewDelegate,PlycPeilvViewdelegate,PlycSelectedViewdelegate,UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
@property (nonatomic, strong) ZBTitleIndexView *titleView;
@property (nonatomic, strong) UIImageView *imageMore;
@property (nonatomic, strong) ZBPlycPeilvView *peilView;
...
@end
@implementation ZBPeilvYichangVC
...
- (void)viewDidLoad {
    ...
    _peilView = [[ZBPlycPeilvView alloc] initWithFrame:CGRectMake(0, 0, Width, Height)];
...
- (void)loadPeilvYichangVCDataWithType:(loadDataType)type
{
    ...
    [[ZBDCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_oddsAbnormalindex] Start:^(id requestOrignal) {
...
{
    if (!_tableView) {
        _tableView = [[ZBBasicTableView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar + 48 + 23, Width, Height - APPDELEGATE.customTabbar.height_myNavigationBar - 48 - 23) style:UITableViewStylePlain];
        _tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
        _tableView.showsVerticalScrollIndicator = NO;
        [_tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"cell"];
        [_tableView registerClass:[ZBPlycCell class] forCellReuseIdentifier:cellPlycCell];
...
{
    ZBPlycCell *cell = [tableView dequeueReusableCellWithIdentifier:cellPlycCell];
    if (!cell) {
        cell = [[ZBPlycCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellPlycCell];
    }
