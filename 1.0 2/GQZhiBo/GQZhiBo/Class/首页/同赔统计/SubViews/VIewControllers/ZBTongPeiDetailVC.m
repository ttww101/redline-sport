...
#import "ZBTongpeiDTResultView.h"
...
@property (nonatomic, strong) ZBTongpeiDTModel *spfModel;
...
- (void)viewDidLoad {
    ...
    _titleView = [[ZBTitleIndexView alloc] initWithFrame:CGRectMake(0, Height - 44, Width, 44)];
...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        [_tableView registerClass:[ZBTongpeiDetailCell class] forCellReuseIdentifier:cellTongPeiDetailVC];
