...
- (void)setModel:(ZBUserModel *)model {
    ...
    for (NSInteger i = 0; i < titleArray.count; i ++) {
        ZBMessageControl *control = [[ZBMessageControl alloc]initWithFrame:CGRectMake(60 + i * width, self.height - 60, width, 60) title:titleArray[i] amount:[contentArray[i] stringValue]];
