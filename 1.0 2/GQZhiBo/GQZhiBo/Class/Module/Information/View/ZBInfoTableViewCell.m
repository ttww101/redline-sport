...
+ (ZBInfoTableViewCell *)cellForTableView:(UITableView *)tableView {
    ...
    if (cell == nil) {
        cell = [[ZBInfoTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
...
- (void)setModel:(InfoGroupModel *)model {
    ...
    self.dataLabel.text = [ZBMethods compareCurrentTime:_model.date];
