...
- (void)setup
{
    ...
    [self registerClass:[ZBNewQBTableViewCell class] forCellReuseIdentifier:cellNewQB];
    [self registerClass:[ZBRightSlidetabletableViewCell class] forCellReuseIdentifier:iden];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
        switch (indexPath.section) {
            ...
            case 3:
            {
                ZBRightSlidetabletableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:iden];
                if (!cell) {
