...
- (void)loadDataZhiBo{
    [[ZBDCHttpRequest shareInstance] sendHtmlGetRequestByMethod:@"get" WithParamaters:nil PathUrlL:[NSString stringWithFormat:@"%@%@%ld.json",APPDELEGATE.url_jsonHeader,@"/jsbf/live/newlive_",self.model.mid] Start:^(id requestOrignal) {
