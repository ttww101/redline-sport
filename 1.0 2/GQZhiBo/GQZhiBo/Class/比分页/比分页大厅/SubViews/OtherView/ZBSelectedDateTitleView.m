...
- (void)didAction {
    if (_delegate && [_delegate respondsToSelector:@selector(ZBSelectedDateTitleViewDidAction:)]) {
        [_delegate ZBSelectedDateTitleViewDidAction:self.arrData];
    }
}
