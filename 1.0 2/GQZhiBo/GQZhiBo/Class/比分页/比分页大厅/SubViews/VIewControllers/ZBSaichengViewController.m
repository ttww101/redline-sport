...
- (ZBHSInfiniteScrollView *)titleScrollView {
    if (!_titleScrollView) {
        _titleScrollView = [[ZBHSInfiniteScrollView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar + 44+60, Width, self.seletedHeight)];
    }
...
{
    if (!_dataTitleView) {
        _dataTitleView = [[ZBSelectedDateTitleView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar + 44+60+14, Width, 60 / 2 + 9)];
