...
- (ZBUserViewofMyBuyTuijian *)UserofMyBuy
{
    if (!_UserofMyBuy) {
        _UserofMyBuy = [[ZBUserViewofMyBuyTuijian alloc] init];
    }
    return _UserofMyBuy;
}
- (ZBTeamViewofTuijianCell *)teamView
{
    if (!_teamView) {
        _teamView = [[ZBTeamViewofTuijianCell alloc] init];
    }
    return _teamView;
}
...
{
    if (!_buymView) {
        _buymView = [[ZBBuyViewofTuijianView alloc] init];
    }
    return _buymView;
}
- (ZBPeilvViewOfTuijianCell *)peilvView
{
    if (!_peilvView) {
        _peilvView = [[ZBPeilvViewOfTuijianCell alloc] init];
    }
    return _peilvView;
}
- (UILabel *)labMoney
