...
@interface ZBAppleIAPService () <SKProductsRequestDelegate, SKPaymentTransactionObserver>
...
@end
@implementation ZBAppleIAPService
+ (instancetype)sharedInstance {
    static dispatch_once_t onceToken;
    static ZBAppleIAPService *service = nil;
    dispatch_once(&onceToken, ^{
        service = [[ZBAppleIAPService alloc]init];
    });
    return service;
}
- (instancetype)init
