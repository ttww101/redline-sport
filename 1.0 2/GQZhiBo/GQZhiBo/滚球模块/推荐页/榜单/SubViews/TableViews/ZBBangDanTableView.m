...
@interface ZBBangDanTableView()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>


@end


@implementation ZBBangDanTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ZBBangDanListCell *cell = [tableView dequeueReusableCellWithIdentifier:acell];
    if (!cell) {
        cell = [[ZBBangDanListCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:acell];
    }
