...
//        _labMoney.attributedText = [ZBMethods withContent:_labMoney.text WithColorText:@"球币" textColor:color33 strFont:font12];
    }
//    隐藏
//    _labMoney.text = @"";
    ...
    if (_model.spf.count>0) {//欧赔
        ...
        [_btnWin setAttributedTitle:[ZBMethods withContent:_btnWin.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"胜" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
        [_btnPing setAttributedTitle:[ZBMethods withContent:_btnPing.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"平" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
        [_btnLose setAttributedTitle:[ZBMethods withContent:_btnLose.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"负" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
...
//        [_btnPing setBackgroundImage:[UIImage imageNamed:@"tuijianDTPeilvSelected2"] forState:UIControlStateSelected];
        ...
        [_btnWin setAttributedTitle:[ZBMethods withContent:_btnWin.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"主" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
...
//        [_btnPing setBackgroundImage:[UIImage imageNamed:@"tuijianDTPeilvSelected2"] forState:UIControlStateSelected];
        ...
        [_btnWin setAttributedTitle:[ZBMethods withContent:_btnWin.currentTitle WithContColor:color66 WithContentFont:font12 WithText:@"大" WithTextColor:color33 WithTextFont:font14] forState:UIControlStateNormal];
...
//    _labCreatTime.text = [NSString stringWithFormat:@"发布于%@",[ZBMethods timeToNowWith:_model.create_time]];
...
//    AnalysisVC *anVC = [[AnalysisVC alloc] init];
    ...
    [[ZBDCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,@"/match"] Start:^(id requestOrignal) {
        
    } End:^(id responseOrignal) {
    } Success:^(id responseResult, id responseOrignal) {
        

        ZBLiveScoreModel *scoremodel = [ZBLiveScoreModel entityFromDictionary:responseOrignal[@"data"]];
...
- (void)sendReportInfomationWithcategory:(NSString *)category
{
    ...
    [[ZBDCHttpRequest shareInstance] sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,url_illegaladd] ArrayFile:nil Start:^(id requestOrignal) {
    } End:^(id responseOrignal) {
