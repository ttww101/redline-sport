...
@interface FaBuSucceedVCViewController ()
...
@implementation FaBuSucceedVCViewController
...
- (void)loadTuiJianDetailView {
    ...
    TuijianDetailVC *tuijianDetailVC = [TuijianDetailVC new];
