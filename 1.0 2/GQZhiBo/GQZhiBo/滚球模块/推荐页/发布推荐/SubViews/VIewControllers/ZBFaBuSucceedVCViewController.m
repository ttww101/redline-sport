//
//  ZBFaBuSucceedVCViewController.m
//  GQapp
//
//  Created by Marjoice on 7/25/17.
...
@interface ZBFaBuSucceedVCViewController ()
...
@implementation ZBFaBuSucceedVCViewController
...
- (void)navViewTouchAnIndex:(NSInteger)index
{
    if (index == 1) {
        //left
//        ZBDan_StringGuanVC *danStringVC = nil;
//        ZBFenxiPageVC *fenxiVC = nil;
//        for (UIViewController *vc in self.navigationController.viewControllers) {
//            
//            if ([vc isKindOfClass:[danStringVC class]]) {
//         
//                danStringVC = (ZBDan_StringGuanVC *)vc;
//                [self.navigationController popToViewController:danStringVC animated:YES];
//            }
//            if ([vc isKindOfClass:[fenxiVC class]]) {
//                
//                fenxiVC = (ZBFenxiPageVC *)vc;
//                [self.navigationController popToViewController:fenxiVC animated:YES];
//            }
//        }
...
- (void)jiXvClick {
    ...
    if ([array[1] isKindOfClass:NSClassFromString(@"ZBFabuTuijianSelectedItemVC")]) {
...
- (void)loadTuiJianDetailView {
    ...
    ZBTuijianDetailVC *tuijianDetailVC = [ZBTuijianDetailVC new];
