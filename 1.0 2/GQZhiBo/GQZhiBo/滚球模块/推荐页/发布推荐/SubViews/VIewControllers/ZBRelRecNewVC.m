...
- (void)didSelectedAtIndex:(NSInteger)index
{
    ...
    switch (index) {
        case 0:{
            _play = @"spf";
            ZBDxModel *dxModel = self.model.spf[0];
        ...
        case 1:{
            _play = @"ya";
            ZBDxModel *dxModel = self.model.rq[0];
           _playContent = [NSString stringWithFormat:@"[%@,\"%@\",%@]",dxModel.UpOdds,dxModel.Goal,dxModel.DownOdds];
            [self.btnOne setTitle:[NSString stringWithFormat:@"主        %.2f",[dxModel.UpOdds floatValue]] forState:UIControlStateNormal];
            self.btnTwo.enabled = NO;
            [self.btnTwo setTitle:[NSString stringWithFormat:@"%@",dxModel.Goal] forState:UIControlStateNormal];
        ...
        case 2:{
            _play = @"dx";
            ZBDxModel *dxModel = self.model.dx[0];
            _playContent = [NSString stringWithFormat:@"[%@,\"%@\",%@]",dxModel.UpOdds,dxModel.Goal,dxModel.DownOdds];
...
- (UIButton *)btnZhu {
    ...
    if (!_btnZhu) {
        ...
        //        [_btnOne setAttributedTitle:[ZBMethods withContent:_btnOne.titleLabel.text WithContColor:color66 WithContentFont:font14 WithText:@"胜" WithTextColor:color33 WithTextFont:font16] forState:UIControlStateNormal];
        //
        //        [_btnOne setAttributedTitle:[ZBMethods withContent:_btnOne.titleLabel.text WithContColor:[UIColor whiteColor] WithContentFont:font14 WithText:@"胜" WithTextColor:[UIColor whiteColor] WithTextFont:font16] forState:UIControlStateSelected];
...
//                [_model.spf enumerateObjectsUsingBlock:^(ZBDxModel* _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
//                    
//                    ZBSelectedViewOfFabuTuijian *selectedView = [[ZBSelectedViewOfFabuTuijian alloc] initWithFrame:CGRectMake(0, 15 + (30 + 12)*idx, Width, 30)];
...
//                [_model.rq enumerateObjectsUsingBlock:^(ZBDxModel* _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
//                    
//                    ZBSelectedViewOfFabuTuijian *selectedView = [[ZBSelectedViewOfFabuTuijian alloc] initWithFrame:CGRectMake(0, 15 + (30 + 12)*idx, Width, 30)];
//                    selectedView.companyIndex = idx;
//
...
//                [_model.dx enumerateObjectsUsingBlock:^(ZBDxModel* _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
//                    
//                    ZBSelectedViewOfFabuTuijian *selectedView = [[ZBSelectedViewOfFabuTuijian alloc] initWithFrame:CGRectMake(0, 15 + (30 + 12)*idx, Width, 30)];
//                    selectedView.companyIndex = idx;
//                    selectedView.newTypeNum = _newTypeNum;
...
//        _btnOne.titleLabel.attributedText = [ZBMethods withContent:_btnOne.titleLabel.text WithColorText:@"胜" textColor:color66 strFont:BoldFont6(fontSize14)];
    }
    return _btnOne;
}
...
//        _btnTwo.titleLabel.attributedText = [ZBMethods withContent:_btnTwo.titleLabel.text WithColorText:@"胜" textColor:color66 strFont:BoldFont6(fontSize14)];
    }
    return _btnTwo;
}
...
//        _btnThree.titleLabel.attributedText = [ZBMethods withContent:_btnThree.titleLabel.text WithColorText:@"胜" textColor:color66 strFont:BoldFont6(fontSize14)];
    }
    return _btnThree;
}
...
- (void)didselectedAtIndex:(NSInteger)index WithModel:(ZBDxModel *)selectedModel WithCompanyIndex:(NSInteger)companyIndex
{
    ...
    [_arrSelectedView enumerateObjectsUsingBlock:^(ZBSelectedViewOfFabuTuijian *_Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
