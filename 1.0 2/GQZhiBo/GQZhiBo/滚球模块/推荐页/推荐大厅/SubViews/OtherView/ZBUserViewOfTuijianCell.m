...
@interface ZBUserViewOfTuijianCell()
...
@end
@implementation ZBUserViewOfTuijianCell
...
//    
    ...
    if (remark.count == 0) {
        ...
        ZBUsermarkModel *usermark = [remark firstObject];
        ...
        if (usermark.type == 1) {
            ...
            //                self.labRemark1.layer.borderColor = [UIColor clearColor].CGColor;
...
//        _labRemark1.layer.borderWidth = 0.5;
...
//        _labRemark2.layer.borderWidth = 0.5;
