...
@interface ZBTuijianSelectedItemView()<UIGestureRecognizerDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,TuijianSelectedItemTitleViewDelegate>
...
@end
@implementation ZBTuijianSelectedItemView
