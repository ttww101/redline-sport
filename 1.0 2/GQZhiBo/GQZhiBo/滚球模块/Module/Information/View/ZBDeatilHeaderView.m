...
@implementation ZBDeatilHeaderView
...
- (void)setGroupModel:(InfoGroupModel *)groupModel {
    ...
    self.dataLabel.text = [ZBMethods compareCurrentTime:_groupModel.date];
...
- (void)avatarClick {
    ...
    album.imgArr = [NSMutableArray arrayWithObject:[NSString stringWithFormat:@"http://mobile.gunqiu.com/avatar/%zi",_groupModel.userId]];//可以是图片的url字符串数组，亦可以是UIImage
