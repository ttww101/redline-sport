...
@interface ZBInputViewController () <UITextViewDelegate>
...
@implementation ZBInputViewController
...
- (void)upContent {
    ...
    [[ZBDCHttpRequest shareInstance]sendRequestByMethod:@"post" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,info_like_comment] ArrayFile:nil Start:^(id requestOrignal) {
