...
#import "ZBJiXianVC.h"//极限拐点
#import "ZBBettingVC.h"//投注异常
#import "ZBPanwangZhishuVC.h"//盘王指数
#import "ZBJiaoYiViewController.h"//交易冷热
#import "ZBBaolengZhishuVC.h"//爆冷指数
#import "ZBTongpeiTongjiVC.h"//同赔指数
#import "ZBPeilvYichangVC.h"//赔率异常
#import "ZBYapanZhoushouVC.h"//亚盘助手
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section) {
        ...
        case 5:
        {
            ...
            return 190;
            //            return [tableView fd_heightForCellWithIdentifier:@"first5" cacheByIndexPath:indexPath configuration:^(ZBTuijianDatingCell *cell) {
            //                if (_hotRecommed.count>0) {
...
//
//            [APPDELEGATE.customTabbar pushToViewController:odd animated:YES];
//            ZBModelPredictionViewController *control = [[ZBModelPredictionViewController alloc]init];
//            [self.navigationController pushViewController:control animated:YES];
