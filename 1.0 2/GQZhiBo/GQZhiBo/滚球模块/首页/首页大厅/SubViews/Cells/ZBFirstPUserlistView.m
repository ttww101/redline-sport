...
@interface ZBFirstPUserlistView()
@property (nonatomic, strong) UIView *basicView;

@end

@implementation ZBFirstPUserlistView
...
//    CGFloat space = ((Width - 54)- btnwidth*4)/(4 -1);
    ...
    [_arrData enumerateObjectsUsingBlock:^(ZBUserlistModel*  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (void)btntouch:(UIButton *)btn
{
    ...
    ZBUserlistModel *mode = [_arrData objectAtIndex:btn.tag];
