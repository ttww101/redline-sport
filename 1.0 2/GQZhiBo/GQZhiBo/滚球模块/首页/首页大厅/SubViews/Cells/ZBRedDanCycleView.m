...
@interface ZBRedDanCycleView()<UICollectionViewDataSource, UICollectionViewDelegate>
...
@end
@implementation ZBRedDanCycleView
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[ZBRedDanCell class] forCellWithReuseIdentifier:@"UICollectionViewCell"];
...
{
    ZBRedDanCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"UICollectionViewCell" forIndexPath:indexPath];
