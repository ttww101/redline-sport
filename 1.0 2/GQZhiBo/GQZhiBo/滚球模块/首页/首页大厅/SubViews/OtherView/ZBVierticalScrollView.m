...
@interface ZBVierticalScrollView ()
@property (nonatomic,strong) NSMutableArray *titles;
@property(assign, nonatomic)int titleIndex;
@property(assign, nonatomic)int index;

@end
@implementation ZBVierticalScrollView
...
//        NSMutableAttributedString *attributeString = [ZBMethods withContent:btn.titleLabel.text WithColorText:@"" textColor:color33 strFont:font12];
//        
//        [attributeString setAttributes:@{NSForegroundColorAttributeName : redcolor,   NSFontAttributeName : font12} range:NSMakeRange(0, 4)];
//    
...
//    NSMutableAttributedString *attributeString = [ZBMethods withContent:modelBtn.titleLabel.text WithColorText:@"" textColor:color33 strFont:font12];
//    
//    [attributeString setAttributes:@{NSForegroundColorAttributeName : redcolor,   NSFontAttributeName : font12} range:NSMakeRange(0, 4)];
//    
//    [modelBtn setAttributedTitle:attributeString forState:UIControlStateNormal];
