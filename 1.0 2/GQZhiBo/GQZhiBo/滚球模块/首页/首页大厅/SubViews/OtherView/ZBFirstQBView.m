...
- (void)setModel:(ZBFirstPInfoListModel *)model{
    _model = model;
    self.labLeague.text = model.league;
    self.labTime.text = [ZBMethods getDateByStyle:dateStyleFormatterMdHm withDate:[NSDate dateWithTimeIntervalSince1970:model.matchtime/1000]];
