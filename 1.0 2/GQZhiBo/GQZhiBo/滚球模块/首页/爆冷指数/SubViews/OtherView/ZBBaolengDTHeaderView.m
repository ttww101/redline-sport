...
@implementation ZBBaolengDTHeaderView
...
- (void)setModel:(ZBBaolengDTModel *)model
{
    _model = model;
    for (int i = 0; i<3; i++) {
...
//                }
                ...
                [labTitle setAttributedText:[ZBMethods withContent:labTitle.text WithColorText:@"%" textColor:labTitle.textColor strFont:font12]];
            ...
            case 1:
            {
                ...
                labTitle.attributedText  = [ZBMethods withContent:labTitle.text WithColorText:@"场" textColor:color33 strFont:font12];
                labWin.textColor = color99;
                labWin.text = @"距上次爆冷";
