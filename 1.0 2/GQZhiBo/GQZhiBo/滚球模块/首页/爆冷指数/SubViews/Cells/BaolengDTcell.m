...
- (void)setModel:(BaolengMatchModel *)model
{
    _model = model;
    ...
    _labTime.text = [Methods getDateByStyle:DateFormatterYearH withDate:[NSDate dateWithTimeIntervalSince1970:_model.matchtime/1000] ];
