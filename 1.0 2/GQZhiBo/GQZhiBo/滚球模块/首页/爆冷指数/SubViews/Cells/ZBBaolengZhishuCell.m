...
@end
@implementation ZBBaolengZhishuCell
...
- (void)setModel:(ZBBaolengZishuModel *)model
{
    _model = model;
...
//    _labLeague.textColor = [ZBMethods getColor:_model.sclassColor];
    _labTime.text = [ZBMethods getDateByStyle:dateStyleFormatterMdHm withDate:[NSDate dateWithTimeIntervalSince1970:_model.mtime/1000]];
...
//    _labCompany.text = _model.company;
    ...
    _labBaolengRate.attributedText = [ZBMethods withContent:_labBaolengRate.text WithColorText:@"%" textColor:_labBaolengRate.textColor strFont:font12];
