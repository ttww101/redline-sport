...
- (void)setcontentWithData:(WithdrawaListModel *)model {
    ...
    [att addAttribute:NSFontAttributeName value:FONT_DIN_Bold_SIZE(60.f) range:[text rangeOfString:PARAM_IS_NIL_ERROR([ZBMethods amountFormater:model.total_reward_amount])]];
