...
@property (nonatomic , strong) ZBLiveQuizAlertView *isaView;
...
@implementation ZBLiveQuizAlertView
...
+ (instancetype)showPaymentInfo:(id)information
    ...
    static ZBLiveQuizAlertView *payView = nil;
    if (!payView) {
        payView = [[ZBLiveQuizAlertView alloc]initWithFrame:windowView.bounds];
    }
