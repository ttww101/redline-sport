...
//        self.arrData = [[NSMutableArray alloc] initWithArray:[ZBTouZhuModel arrayOfEntitiesFromArray:responseOrignal[@"data"]]];
...
//        [ZBCacheObject storage_Memory_UrlKey:@"touzhu" data:responseOrignal[@"data"] hour:5];//缓存数据
        [self setDataToArr];
