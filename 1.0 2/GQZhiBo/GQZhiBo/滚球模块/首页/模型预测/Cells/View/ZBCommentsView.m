...
- (void)loadData {
    ...
    [[ZBDCHttpRequest shareInstance]sendGetRequestByMethod:@"get" WithParamaters:parameter PathUrlL:[NSString stringWithFormat:@"%@%@",APPDELEGATE.url_Server,info_url_commentcount] Start:^(id requestOrignal) {
...
//        _badgeNumberLabel.layer.cornerRadius = 5;
//        _badgeNumberLabel.layer.masksToBounds = YES;
