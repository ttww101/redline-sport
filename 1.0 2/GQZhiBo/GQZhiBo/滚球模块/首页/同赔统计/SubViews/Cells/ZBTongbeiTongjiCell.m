...
@end
@implementation ZBTongbeiTongjiCell
...
- (void)setModel:(ZBTongPeiTJModel *)model
{
    _model = model;
...
//    }
    ...
    _labRate.textColor = [ZBMethods getColor:_model.resultColor];
    _labRateTitle.textColor = [ZBMethods getColor:_model.resultColor];
    _labRound.text = [NSString stringWithFormat:@"共%ld场",_model.num];
    _labRound.textColor =color66;
    _labRate.attributedText = [ZBMethods withContent:_labRate.text WithColorText:@"%" textColor:[ZBMethods getColor:_model.resultColor] strFont:font12];
