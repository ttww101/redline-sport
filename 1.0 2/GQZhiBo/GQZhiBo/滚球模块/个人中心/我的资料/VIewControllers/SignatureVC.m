...
@property (nonatomic, weak)NavView *navV;
...
//                [SVProgressHUD showImage:[UIImage imageNamed:@""] status:@"个性签名提交成功"];
                ...
                SucessViewOfSignatureView *successView = [[SucessViewOfSignatureView alloc] initWithFrame:CGRectMake(0, APPDELEGATE.customTabbar.height_myNavigationBar, Width, Height - APPDELEGATE.customTabbar.height_myNavigationBar) ];
