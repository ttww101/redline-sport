...
#define cellUserTongjiCollection @"ZBUserTongjiCollectioncell"
@interface ZBUserTongjiCell()<UICollectionViewDataSource, UICollectionViewDelegate>


@property (nonatomic, weak) UICollectionView *mainView; // 显示图片的collectionView
@property (nonatomic, weak) UICollectionViewFlowLayout *flowLayout;

//底部的三个view  类似于pagecontrol
@property (nonatomic, strong) NSMutableArray *arrViewItems;
@property (nonatomic, strong) NSMutableArray *arrViewItemTitles;

@end
@implementation ZBUserTongjiCell
...
- (void)setModel:(ZBUserTongjiAllModel *)model
{
    _model = model;
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[ZBUserTongjiCollectioncell class] forCellWithReuseIdentifier:cellUserTongjiCollection];
...
//    viewTap1.backgroundColor =redcolor;
...
//    viewTap2.backgroundColor =redcolor;
...
//    viewTap3.backgroundColor =redcolor;
...
{
    ZBUserTongjiCollectioncell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellUserTongjiCollection forIndexPath:indexPath];
