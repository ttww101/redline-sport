...
@interface ZBUserTongjiCollectioncell ()<ChartViewDelegate>
@property (nonatomic,strong) LineChartView * lineView;
@property (nonatomic,strong) UILabel * markY;

@end
@implementation ZBUserTongjiCollectioncell
- (void)setModel:(ZBUserTongjiModel *)model
{
    ...
    ZBRoundUserView *roundWin = [[ZBRoundUserView alloc] initWithFrame:CGRectMake(15, 10, 100*scaleRoundWidth, 100*scaleRoundWidth)];
    ...
    ZBRoundUserView *roundProfit = [[ZBRoundUserView alloc] initWithFrame:CGRectMake(roundWin.right + 10, 10, 100*scaleRoundWidth, 100*scaleRoundWidth)];
    ...
    ZBUserTuijianNumView *numV = [[ZBUserTuijianNumView alloc] initWithFrame:CGRectMake(Width - 15 - 100*scaleRoundWidth, 0, 100*scaleRoundWidth, 96)];
...
//        _lineView.descriptionText = @"描述文字";
        ...
        leftAxis.valueFormatter = [[ZBSymbolsValueFormatter alloc]init];
...
//    }
    ...
    for (int i = 0; i<_model.groupTimeStatis.count; i++) {
        ZBTotalrateModel *model = [_model.groupTimeStatis objectAtIndex:i];
    ...
    _lineView.xAxis.valueFormatter = [[ZBDateValueFormatter alloc]initWithArr:arrXlabs];
    ...
    if (_lineView.data.dataSetCount > 0) {
        ...
        set1.valueFormatter = [[ZBSetValueFormatter alloc]initWithArr:arrValueProfit];
        return data;
    }else{
