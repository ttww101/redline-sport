...
#define cellUserTongjiCollection @"UserTongjiCollectioncell"
@interface UserTongjiCell()<UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)setModel:(UserTongjiAllModel *)model
{
    _model = model;
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[UserTongjiCollectioncell class] forCellWithReuseIdentifier:cellUserTongjiCollection];
...
{
    UserTongjiCollectioncell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellUserTongjiCollection forIndexPath:indexPath];
