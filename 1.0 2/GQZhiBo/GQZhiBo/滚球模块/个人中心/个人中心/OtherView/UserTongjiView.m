...
#import "UserTongjiView.h"
@interface UserTongjiView()
...
- (void)setModel:(StatisticsModel *)model
{
    ...
    if ([_model.win_rate floatValue]>0) {
        ...
        if ([_labWinRate.text containsString:@"."]) {
            _labWinRate.attributedText = [Methods withContent:_labWinRate.text WithColorText:[_labWinRate.text substringFromIndex:_labWinRate.text.length - 3] textColor:redcolor strFont:font12];
        } else {
             _labWinRate.attributedText = [Methods withContent:_labWinRate.text WithColorText:@"%" textColor:redcolor strFont:font12];
        }
        ...
        if ([_labWinRate.text containsString:@"."]) {
            ...
            _labWinRate.attributedText = [Methods withContent:_labWinRate.text WithColorText:[_labWinRate.text substringFromIndex:_labWinRate.text.length - 3] textColor:color99 strFont:font12];
            
        } else {
            _labWinRate.attributedText = [Methods withContent:_labWinRate.text WithColorText:@"%" textColor:color99 strFont:font12];
        }
//        _labWinRate.attributedText = [Methods withContent:_labWinRate.text WithColorText:@"%" textColor:color99 strFont:font12];
    ...
    if ([_model.profit_rate floatValue]>0) {
        ...
        _labProfite.attributedText = [Methods withContent:_labProfite.text WithColorText:[_labProfite.text substringFromIndex:_labProfite.text.length - 3] textColor:redcolor strFont:font12];
        
    }else{
        _labProfite.textColor = color99;
        _labProfite.attributedText = [Methods withContent:_labProfite.text WithColorText:[_labProfite.text substringFromIndex:_labProfite.text.length - 3] textColor:color99 strFont:font12];
