...
#import "ZBFansCell.h"
@interface ZBFansTable()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>

@end
@implementation ZBFansTable
...
- (id)initWithFrame:(CGRect)frame style:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        [self registerClass:[ZBFansCell class] forCellReuseIdentifier:cellFansTable];
...
{
    ZBFansCell *cell = [tableView dequeueReusableCellWithIdentifier:cellFansTable];
    if (!cell) {
        cell = [[ZBFansCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellFansTable];
    }
    ...
    //    }
    ZBFansModel *model = [_arrData objectAtIndex:indexPath.row];
    cell.model = model;
