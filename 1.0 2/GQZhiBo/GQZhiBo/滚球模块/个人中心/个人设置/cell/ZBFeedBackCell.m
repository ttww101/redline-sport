...
@implementation ZBFeedBackCell

- (void)setFeedModeltmp:(ZBFeedBackModel *)feedModeltmp {
...
//        _labDetail.text = @"在比分页面的球队对战中，点进去信息不符";
...
//        _labReCallDetail.text = @"你好，你所说的问题已解决，谢谢你的反馈";
