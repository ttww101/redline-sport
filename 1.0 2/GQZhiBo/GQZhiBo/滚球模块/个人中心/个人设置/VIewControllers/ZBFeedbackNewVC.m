...
@interface ZBFeedbackNewVC ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate>
...
@implementation ZBFeedbackNewVC
...
- (ZBFeedBackHeaderView *)feedBackHeaderView {
    ...
    if (!_feedBackHeaderView) {
        _feedBackHeaderView = [[ZBFeedBackHeaderView alloc] initWithFrame:CGRectMake(12, APPDELEGATE.customTabbar.height_myNavigationBar + 10, Width - 30, 331)];
    }
