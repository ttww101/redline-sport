...
@interface ZBSettingVC ()<UITableViewDelegate,UITableViewDataSource>
...
//                    lab.attributedText = [ZBMethods withContent:lab.text WithColorText:currentVersion textColor:color99 strFont:font13];
...
//        labQun.font = font12;
//        [labQun setAttributedText:[ZBMethods withContent:@"QQ交流群：198898776（验证：滚球体育）" contentColor:color33 WithColorText:@"（验证：滚球体育）" textColor:color99]];
    ...
    if (indexPath.section == 0) {
        ...
        switch (indexPath.row) {
            ...
            case 1:
            {
                ...
                ZBPushSettingVC *pushSetVC = [[ZBPushSettingVC alloc] init];
