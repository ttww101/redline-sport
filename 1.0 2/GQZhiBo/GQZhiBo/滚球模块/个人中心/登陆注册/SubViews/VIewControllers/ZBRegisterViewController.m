...
@property (nonatomic, strong) ZBJKCountDownButton *checkBtn;
...
//    _checkTextF.borderStyle = UITextBorderStyleRoundedRect;
    ...
    _checkBtn = [[ZBJKCountDownButton alloc] initWithFrame:CGRectMake(_checkTextF.frame.origin.x + _checkTextF.frame.size.width - 10, textHeight + 10, 80, textHeight - 20)];
...
- (void)connectRongyunWithUserModel:(ZBUserModel *)user
{}
//{
