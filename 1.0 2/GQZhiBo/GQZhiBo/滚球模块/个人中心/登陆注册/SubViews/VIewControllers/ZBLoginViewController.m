...
@interface ZBLoginViewController ()<UITextFieldDelegate>
{
...
{
    ZBForgetPswViewController *forgetPswVC = [[ZBForgetPswViewController alloc] init];
...
- (void)everRegisterThirdPartLoginWithUsername:(NSString *)username nickName:(NSString *)nickname picUrl:(NSString *)pic resource:(NSString *)resource
{
    ...
    ZBBangUserVC *bangVC = [ZBBangUserVC new];
