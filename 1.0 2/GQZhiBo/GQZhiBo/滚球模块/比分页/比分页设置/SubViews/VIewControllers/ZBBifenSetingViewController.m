...
@interface ZBBifenSetingViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation ZBBifenSetingViewController
...
//                    switchBtn.tag = 13;
                ...
                case 1:
                    ...
                    [lab setAttributedText:[ZBMethods withContent:@"编号(竞彩、北单、足彩)" WithColorText:@"(竞彩、北单、足彩)" textColor:grayColor3 strFont:font11]];
                ...
                case 4: //5
                {
                    ...
                    switchBtn.tag = 15;
                    switchBtn.hidden = YES;
//                    [lab setAttributedText:[ZBMethods withContent:@"赔率显示 (3选2)" WithColorText:@"(3选2)" textColor:grayColor3 strFont:font13]];
