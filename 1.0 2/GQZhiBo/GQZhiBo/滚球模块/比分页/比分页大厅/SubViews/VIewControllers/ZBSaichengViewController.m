...
//                NSArray *arrNowdate;
//                if (_currentFlag == 1) {
//                    arrNowdate = [ZBMethods getDateByDate:[ZBMethods getDateFromString:model.name byformat:@"yyyyMMdd"] withWeekType:weekTypeZhou];
//                    
//                }else{
//                    arrNowdate = [ZBMethods getDateByDate:[ZBMethods getDateFromString:model.name byformat:@"yyyy-MM-dd"] withWeekType:weekTypeZhou];
//                    
//                }
//                
