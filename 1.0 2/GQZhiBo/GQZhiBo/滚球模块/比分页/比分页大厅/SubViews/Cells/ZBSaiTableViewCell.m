...
- (void)setScoreModel:(ZBLiveScoreModel *)ScoreModel
{
...
//    }
    ...
    _eventLab.textColor = [ZBMethods getColor:_ScoreModel.leagueColor];
    ...
    if ([arrPeilv containsObject:@"8002"] && [arrPeilv containsObject:@"8001"]) {
        ...
        if (arrletgoal.count==3) {
            ...
            for (int i = 0; i<arr.count; i++) {
                ...
                if ([ZBMethods isPureInt:str]) {
                    str = [NSString stringWithFormat:@"%d",[str intValue]];
                }else if ([ZBMethods isPureFloat:str]){
...
//            _baoBtn.layer.borderColor = [UIColor clearColor].CGColor;
    ...
    switch (_ScoreModel.matchstate) {
        ...
        {
            //上半场
            NSString *timeCha =[ZBMethods intervalFromLastDate:_ScoreModel.matchtime2 toTheDate:time];
        ...
        {
            //下半场
            NSString *timeCha = [ZBMethods intervalFromLastDateAnd45:_ScoreModel.matchtime2 toTheDate:time];
