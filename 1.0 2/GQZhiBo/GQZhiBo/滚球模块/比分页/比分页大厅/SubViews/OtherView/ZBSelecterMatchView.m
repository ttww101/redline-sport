...
@interface ZBSelecterMatchView()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,UIGestureRecognizerDelegate>
@end
@implementation ZBSelecterMatchView
...
{
    if (_delegate && [_delegate respondsToSelector:@selector(ZBSelecterMatchView:selectedAtIndex:)]) {
        [_delegate ZBSelecterMatchView:self selectedAtIndex:indexPath.row];
    }
}
