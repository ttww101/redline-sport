...
@interface ZBSelectedChupanVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,AllSelectedViewDelegate>
...
@implementation ZBSelectedChupanVC
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        [self.collectionView registerClass:[ZBSelectedCCell class] forCellWithReuseIdentifier:cellCollectioneSlectedChupan];
...
{
    ZBSelectedCCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellCollectioneSlectedChupan forIndexPath:indexPath];
    if (!cell) {
        NSLog(@"无法创建cell");
    }
