...
@implementation ZBJiShiPeiLvCell
...
/*
- (void)setJiShiPeiLvDetailModel:(ZBJiShiPeiLvDetailModel *)jiShiPeiLvDetailModel {
    
    _jiShiPeiLvDetailModel = jiShiPeiLvDetailModel;
    [self.contentView addSubview:self.basicView];
    
    _miniTime.text = @"44";
    _score.text = @"1-1";
    _homeOdds0.text = @"0.86";
    _panKou0.text = @"-0/0.5";
    _awayOdds0.text = @"1.02";
    _homeOdds.text = @"0.90";
    _panKou.text = @"-0/0.5";
    _awayOdds.text = @"1.75";
...
//        _homeOdds0.textColor = [UIColor greenColor];
