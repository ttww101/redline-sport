...
@implementation ZBDoubleBattlecell
...
- (void)setBattlModel:(ZBBattleModel *)battlModel {
...
- (UILabel *)labRed {
    ...
    if (!_labRed) {
        _labRed = [UILabel new];
//        _labRed.text = @"拉斐尔·瓦格纳";
        _labRed.font = font14;
//        _labRed.backgroundColor = colorEEEEEE;
//        _labRed.backgroundColor = redcolor;
...
//        _labBlue.text = @"道格拉斯多斯";
        _labBlue.font = font14;
//        _labBlue.textColor = colorEEEEEE;
//        _labBlue.backgroundColor = [UIColor blueColor];
...
- (void)addCellAutoLayout {
    ...
    [self.labRed mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        //make.width.mas_equalTo(Width/2 - 58);
    }];
    [self.lableRed mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(self.btnRed);
      //  make.left.mas_equalTo(self.btnRed).offset(2);
    ...
    [self.lableBlue mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        //make.right.mas_equalTo(self.labBlue).offset(2);
    }];
