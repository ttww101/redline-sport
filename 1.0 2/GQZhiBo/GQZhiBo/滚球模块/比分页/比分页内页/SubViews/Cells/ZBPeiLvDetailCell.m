...
//赔率详情 cell
@interface ZBPeiLvDetailCell()
@property (nonatomic, strong) UIView            *basicView;


@end

@implementation ZBPeiLvDetailCell
...
//    
//    _labTeamTime.text = [NSString stringWithFormat:@"%@",array[1]];
//    _labTeamScore.text = array[6];
//    _labTeamOdds.text = array[2];
//    _labBollScore.text = array[5];
//    _labOddsChang.text = array[0];
//    _labMatchTime.text = @"10:27";
//    
//    [self addCellAutoLayout];
}

- (void)setModelPeiLvDetail:(ZBPeiLvDetailModel *)modelPeiLvDetail {
...
//        _labTeamScore.textColor = redcolor;
...
//        _labTeamOdds.textColor = [UIColor greenColor];
