...
@interface ZBNewQBTableViewCell ()
//是否添加过约束
...
- (void)setModel:(ZBInfoListModel *)model
{
    _model = model;
    ...
    [_labContent setAttributedText:[ZBMethods setTextStyleWithString:_model.content WithLineSpace:6 WithHeaderIndent:heightHeaderIndent]];
    if (_hideBottomView) {
