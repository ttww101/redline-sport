...
- (void)setJsplDwonModel:(ZBJSPLDownMode *)jsplDwonModel
{
...
- (void)setJsplDwonTwoModel:(ZBJSPLDownTwoModel *)jsplDwonTwoModel {
...
//        if (jsplDwonTwoModel.Js_Up>jsplDwonTwoModel.Js_Up2) {
//            self.labJSLeft.textColor=[UIColor redColor];
//        }else{
//            self.labJSLeft.textColor=[UIColor greenColor];
//        }
...
- (UILabel *)labKPLeft {
    ...
    if (!_labKPLeft) {
        ...
        //        _score.backgroundColor = redcolor;
