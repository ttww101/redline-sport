...
@interface ZBZhiboTableView()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate,FoldSectionHeaderViewDelegate,SRWebSocketDelegate>
{
    NSTimer* _timer;
    NSInteger num;
}
...
//"角球让球赔率"
@property (nonatomic, strong) ZBJSPLDownMode *jsplDownone;
//"角球大小赔率"
@property (nonatomic, strong) ZBJSPLDownTwoModel *jsplDownTwo;
...
@end
@implementation ZBZhiboTableView
...
- (id)initWithFrame:(CGRect)frame style:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        [self registerClass:[ZBJishiFirstCell class] forCellReuseIdentifier:jiShiFirstCellID];
        [self registerClass:[ZBJiShiPeiLvCell class] forCellReuseIdentifier:jiShiPeilvDetailCellID];
        [self registerClass:[ZBDoubleBattlecell class] forCellReuseIdentifier:doubleBattleCell];
        [self registerClass:[ZBJSPLDownCell class] forCellReuseIdentifier:jSPLDownCelliD];
        [self registerClass:[ZBBisaiTongjiCell class] forCellReuseIdentifier:cellBisaiTongji];
        [self registerClass:[ZBBisaiTongjiCellTwo class] forCellReuseIdentifier:cellBisaiTongjiTwo];
...
- (void)setModel:(ZBLiveScoreModel *)model
{
    ...
    ZBLiveEventMedel *start = [[ZBLiveEventMedel alloc] init];
    start.headerOrFooter = 1;
    
    ZBLiveEventMedel *end = [[ZBLiveEventMedel alloc] init];
        ...
        case 0:
        {
            ...
            if (section == 2 ) {
                ...
                if (self.jsplDownone == nil ) {
                    ...
                    ZBHSJFoldHeaderView *headerView = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"header"];
                    if (!headerView) {
                        headerView = [[ZBHSJFoldHeaderView alloc] initWithReuseIdentifier:@"header"];
                    }
        ...
        case 1: //1
        {
            ...
            switch (section) {
                case 0:
                {
                    ...
                    ZBBisaiTJHeaderView *view = [[ZBBisaiTJHeaderView alloc] initWithFrame:CGRectMake(0, 0, Width, 170)];
    ...
    switch (_currentIndex) {
        case 0:
        {
            if (indexPath.section == 0 ) {
                ...
                if (indexPath.row == 0) {
                    ...
                    ZBJiShiPeiLvCell *jiShiPeiLvCell = [tableView cellForRowAtIndexPath:indexPath];
                    if (!jiShiPeiLvCell) {
                        jiShiPeiLvCell = [[ZBJiShiPeiLvCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:jiShiPeilvDetailCellID];
                    }
                ...
                ZBJSPLDownCell *jSPLDownC = [tableView cellForRowAtIndexPath:indexPath];
                if (!jSPLDownC) {
                    jSPLDownC = [[ZBJSPLDownCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:jSPLDownCelliD];
                }
                ...
                ZBJSPLDownCell *jSPLDownTwo = [tableView cellForRowAtIndexPath:indexPath];
                if (!jSPLDownTwo) {
                    jSPLDownTwo = [[ZBJSPLDownCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:jSPLDownCelliD];
                }
        ...
        case 1:
        {
            switch (indexPath.section) {
                ...
                case 2:
                {
                    ZBBisaiTongjiCell *cell = [tableView dequeueReusableCellWithIdentifier:cellBisaiTongji];
                    if (!cell) {
                        cell = [[ZBBisaiTongjiCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellBisaiTongji];
                    }
                    
                    
                    //cell.model = _event[indexPath.row];
//                    [cell setModel:[_event objectAtIndex:indexPath.row]];
                    ZBLiveEventMedel*model=_event[indexPath.row];
                ...
                case 1:
                {
                    ZBBisaiTongjiCellTwo *cell = [tableView dequeueReusableCellWithIdentifier:cellBisaiTongjiTwo];
                    if (!cell) {
                        cell = [[ZBBisaiTongjiCellTwo alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellBisaiTongjiTwo];
                    }
    ...
    switch (_currentIndex) {
        case 0:
        {
            if (indexPath.section == 0 || indexPath.section == 1) {
                ...
                ZBPeiLvDetailVC *peilvDDT = [[ZBPeiLvDetailVC alloc]init];
...
- (void)loadDoubleBatData {
    ...
    [[ZBDCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:nil PathUrlL:[NSString stringWithFormat:@"%@%@%ld.json",APPDELEGATE.url_jsonHeader,@"/jsbf/live/newbacklive_",(long)self.model.mid] Start:^(id requestOrignal) {
...
//        self.defaultTitle = @"";
        ...
        if ([responseOrignal objectForKey:@"up"]) {
            ...
            _upArr = [[NSMutableArray alloc] initWithArray:[ZBBattleModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"up"]]];
            if (_upArr.count>0) {
                ZBBattleModel*model=[ZBBattleModel new];
                model.homenumber=@"";
                model.guestnumber=@"";
        ...
        if ([responseOrignal objectForKey:@"back"]) {
            ...
            _backArr = [[NSMutableArray alloc] initWithArray:[ZBBattleModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"back"]]];
            if (_backArr.count>0) {
                ZBBattleModel*model=[ZBBattleModel new];
                model.homenumber=@"";
                model.guestnumber=@"";
...
- (void)loadDataZhiBo{
    ...
    [[ZBDCHttpRequest shareInstance] sendGetRequestByMethod:@"get" WithParamaters:nil PathUrlL:[NSString stringWithFormat:@"%@%@%ld.json",APPDELEGATE.url_jsonHeader,@"/jsbf/live/newlive_",(long)self.model.mid] Start:^(id requestOrignal) {
        
    } End:^(id responseOrignal) {
        
    } Success:^(id responseResult, id responseOrignal) {
        NSLog(@"统计返回=%@",responseOrignal);
        _event = [[NSMutableArray alloc] initWithArray:[ZBLiveEventMedel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"event"]]];
...
NSLog(@"返回的数据333=%ld",_event.count);
        ...
        if ([responseOrignal objectForKey:@"tech"]) {
            _tech = [[NSArray alloc] initWithArray:[ZBTechModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"tech"]]];
        }
        if ([responseOrignal objectForKey:@"techtwo"]) {
            _techtwo = [[NSArray alloc] initWithArray:[ZBTechtwoModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"techtwo"]]];
        }
        
        if ([responseOrignal objectForKey:@"homestatis"]) {
            _homestatis =[[NSArray alloc] initWithArray:[ZBliveLineupModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"homestatis"]]];
        }
        if ([responseOrignal objectForKey:@"gueststatis"]) {
            _gueststatis = [[NSArray alloc] initWithArray:[ZBliveLineupModel arrayOfEntitiesFromArray:[responseOrignal objectForKey:@"gueststatis"]]];
        }
...
//    ZBTongJiModel*tongjimdel=DataArray[3];
    if (ddd.length>0) {
    
        NSMutableArray *arrEvent = [[NSMutableArray alloc] initWithArray:[ZBLiveEventMedel arrayOfEntitiesFromArray:[TongJiDic objectForKey:@"event"]]];
        ...
        if ([TongJiDic objectForKey:@"tech"]) {
            _tech = [[NSArray alloc] initWithArray:[ZBTechModel arrayOfEntitiesFromArray:[TongJiDic objectForKey:@"tech"]]];
        }
        if ([TongJiDic objectForKey:@"techtwo"]) {
            _techtwo = [[NSArray alloc] initWithArray:[ZBTechtwoModel arrayOfEntitiesFromArray:[TongJiDic objectForKey:@"techtwo"]]];
        }
        
        if ([TongJiDic objectForKey:@"homestatis"]) {
            _homestatis =[[NSArray alloc] initWithArray:[ZBliveLineupModel arrayOfEntitiesFromArray:[TongJiDic objectForKey:@"homestatis"]]];
        }
        if ([TongJiDic objectForKey:@"gueststatis"]) {
            _gueststatis = [[NSArray alloc] initWithArray:[ZBliveLineupModel arrayOfEntitiesFromArray:[TongJiDic objectForKey:@"gueststatis"]]];
        }
