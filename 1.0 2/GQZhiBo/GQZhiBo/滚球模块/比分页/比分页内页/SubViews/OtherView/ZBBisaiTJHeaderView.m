...
#import "ZBBisaiTJRoundView.h"
#import "ZBBisaiTHeaderFenxiView.h"
#import "ZBTechtwoModel.h"
@interface ZBBisaiTJHeaderView()

@end
@implementation ZBBisaiTJHeaderView
...
- (void)setArrdata:(NSArray *)arrdata
{
    ...
    for (int i = 0; i<3; i++) {
        ...
        ZBBisaiTJRoundView *round = [[ZBBisaiTJRoundView alloc] initWithFrame:CGRectMake(0, 40, 40, 40)];
    ...
    if (isOniphone6p) {
        ZBBisaiTHeaderFenxiView *headerLeft = [[ZBBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(20, 90 + 10, 30*4, 25*2)];
        headerLeft.ishome = 0;
        headerLeft.model = home;
        [self addSubview:headerLeft];
        
        
        ZBBisaiTHeaderFenxiView *headerRight = [[ZBBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(Width - 20 - 30*4, 90 + 10, 30*4, 25*2)];
        ...
        ZBBisaiTHeaderFenxiView *headerLeft = [[ZBBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(10, 90 + 10, 25*4, 25*2)];
        headerLeft.ishome = 0;
        headerLeft.model = home;
        ...
        ZBBisaiTHeaderFenxiView *headerRight = [[ZBBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(Width - 10 - 25*4, 90 + 10, 25*4, 25*2)];
        headerRight.ishome = 1;
        headerRight.model = guest;
        ...
        ZBBisaiTHeaderFenxiView *headerLeft = [[ZBBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(10, 90 + 10, 30*4, 25*2)];
        headerLeft.ishome = 0;
        headerLeft.model = home;
        ...
        ZBBisaiTHeaderFenxiView *headerRight = [[ZBBisaiTHeaderFenxiView alloc] initWithFrame:CGRectMake(Width - 10 - 30*4, 90 + 10, 30*4, 25*2)];
        headerRight.ishome = 1;
        headerRight.model = guest;
