...
//        return [Methods getDateByStyle:dateStyleFormatter withDate:[NSDate dateWithTimeIntervalSince1970:[nunber doubleValue]/1000]];
//    }];
//}
...
{
    return [MTLValueTransformer reversibleTransformerWithBlock:^id(NSNumber *number) {
        return [Methods getDateByStyle:dateStyleFormatter withDate:[NSDate dateWithTimeIntervalSince1970:[number doubleValue]/1000]];
    }];
}
+ (NSValueTransformer *)MatchTimeJSONTransformer
{
