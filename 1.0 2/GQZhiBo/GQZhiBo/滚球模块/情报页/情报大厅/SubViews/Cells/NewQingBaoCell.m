...
- (UILabel *)labContent{
    if (!_labContent) {
        ...
        _labContent.attributedText = [Methods setTextStyleWithString:_labContent.text WithLineSpace:5.5 WithHeaderIndent:Width - 30];
    }
    return _labContent;
}
...
- (void)setModel:(QingBaoFPTwoModel *)model{
    _model = model;
    self.labTime.text = [NSString stringWithFormat:@"发布于 %@",[Methods getDateByStyle:@"MM月dd日 HH:mm" withDate:[NSDate dateWithTimeIntervalSince1970:[model.createtime doubleValue]/1000]]];
//    NSString *str = @"";
//    
//    switch (model.choice) {
//        case 3:
...
//    self.labType.backgroundColor = [Methods getColor:model.color];
    self.labTitle.numberOfLines = 2;
    self.labTitle.text = [NSString stringWithFormat:@"%@",model.title];
    
    self.labTitle.attributedText = [Methods setTextStyleWithString:self.labTitle.text WithLineSpace:5 WithHeaderIndent:Width - 30];
...
//    self.labHome.backgroundColor = redcolor;
    ...
    self.labFabuTime.text = [NSString stringWithFormat:@"%@",[Methods getDateByStyle:dateStyleFormatterMdHm withDate:[NSDate dateWithTimeIntervalSince1970:[model.mtime doubleValue]/1000]]];
    self.labLeg.text = model.league;
    self.labLeg.textColor = [Methods getColor:model.leagueColor];
    
    
    self.labContent.attributedText = [Methods setTextStyleWithString:self.labContent.text WithLineSpace:5.5 WithHeaderIndent:Width - 30];
