...
- (void)setModel:(ZBNavigationModel *)model{
    ...
    self.labLeague.textColor = [ZBMethods getColor:model.leagueColor];
    self.labTime.text = [NSString stringWithFormat:@"%@",[ZBMethods getDateByStyle:dateStyleFormatterMdHm withDate:[NSDate dateWithTimeIntervalSince1970:[model.matchtime doubleValue]/1000]]];
